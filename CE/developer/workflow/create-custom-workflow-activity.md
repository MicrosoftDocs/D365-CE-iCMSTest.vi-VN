...
ms.locfileid: "386903"
---
# <a name="create-a-custom-workflow-activity"></a>Create a custom workflow activity
...
## <a name="required-software-and-assemblies"></a>Required software and assemblies
...
## <a name="use-the-codeactivity-workflow-base-class"></a>Use the CodeActivity workflow base class
...
1. Bắt đầu [!INCLUDE[pn_Visual_Studio](../../includes/pn-visual-studio.md)].  
...
## <a name="specify-the-name-and-group-name-for-a-custom-workflow-activity"></a>Specify the name and group name for a custom workflow activity
