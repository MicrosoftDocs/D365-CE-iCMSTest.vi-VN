...
ms.locfileid: "387731"
---
# <a name="add-metadata-to-a-custom-workflow-activity"></a>Add metadata to a custom workflow activity
...
## <a name="add-input-parameters"></a>Add input parameters  
...
<a name="Output"></a>   
## <a name="add-output-parameters"></a>Add output parameters  
...
<a name="InAndOut"></a>   
## <a name="add-input-and-output-attributes-for-the-same-parameter"></a>Add input and output attributes for the same parameter  
...
<a name="Additional"></a>   
## <a name="additional-attributes"></a>Additional attributes  
...
<a name="Execute"></a>   
## <a name="add-the-execute-method"></a>Add the Execute method  
