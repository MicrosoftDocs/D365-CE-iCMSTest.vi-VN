...
ms.locfileid: "385737"
---
# <a name="run-data-import"></a>Run data import
...
<a name="parse"></a>   
## <a name="parse-source-data"></a>Parse source data  
...
<a name="transform"></a>   
## <a name="transform-parsed-data"></a>Transform parsed data  
...
<a name="upload"></a>   
## <a name="upload-transformed-data-to-the-target-server"></a>Upload transformed data to the target server  
...
<a name="log"></a>   
## <a name="log-failures"></a>Log failures  
...
## <a name="import-auditing-data"></a>Import auditing data  
