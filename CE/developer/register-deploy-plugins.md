...
ms.locfileid: "385744"
---
# <a name="register-and-deploy-plug-ins"></a>Register and Deploy Plug-Ins
...
## <a name="plug-in-registration-tool"></a>Plug-in Registration Tool
...
## <a name="plug-in-storage"></a>Plug-in Storage
...
## <a name="assembly-versioning-and-solutions"></a>Assembly Versioning and Solutions
...
## <a name="security-restrictions"></a>Security Restrictions
...
## <a name="register-plug-ins-programmatically"></a>Register Plug-ins Programmatically
...
## <a name="enable-or-disable-custom-code-execution"></a>Enable or Disable Custom Code Execution
...
### <a name="to-enable-custom-code-execution"></a>To enable custom code execution
...
### <a name="to-disable-custom-code-execution"></a>To disable custom code execution
