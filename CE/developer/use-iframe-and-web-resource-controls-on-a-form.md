...
ms.locfileid: "387574"
---
# <a name="use-iframe-and-web-resource-controls-on-a-form"></a>Use IFRAME and web resource controls on a form
...
## <a name="select-whether-to-restrict-cross-frame-scripting"></a> Chọn xem có hạn chế gửi mã lệnh trên khung không  
...
## <a name="pass-contextual-information-about-the-record"></a>Pass contextual information about the record  
...
| Tham số  |        Tên        |                                 Mô tả                                 |
|------------|--------------------|-----------------------------------------------------------------------------|
| `typename` |    Tên Thực thể     |                           Tên thực thể.                           |
...
### <a name="read-passed-parameters"></a>Read passed parameters  
...
## <a name="pass-form-data"></a>Pass form data  
...
## <a name="change-the-url"></a>Change the URL  
