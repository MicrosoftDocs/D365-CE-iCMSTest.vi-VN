...
# <a name="define-custom-claim-mapping-for-sharepoint-server-based-integration"></a>Define custom claim mapping for SharePoint server-based integration
