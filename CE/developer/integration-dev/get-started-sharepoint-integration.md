...
ms.locfileid: "386525"
---
# <a name="get-started-with-sharepoint-integration"></a>Get started with SharePoint integration
...
## <a name="sharepoint-storage-concepts"></a>SharePoint storage concepts  
...
## <a name="software-requirements-for-sharepoint-integration"></a>Software requirements for SharePoint Integration  
...
## <a name="enable-sharepoint-integration"></a>Enable SharePoint integration  
...
## <a name="microsoft-dynamics-crm-list-component-for-microsoft-sharepoint-server"></a>Microsoft Dynamics CRM list component for Microsoft SharePoint Server  
...
- Automatic creation of the document locations on the [!INCLUDE[pn_SharePoint_Server_short](../../includes/pn-sharepoint-server-short.md)] server.  
  ...
  Có hai phiên bản [!INCLUDE[pn_list_component_short](../../includes/pn-list-component-short.md)]:  
