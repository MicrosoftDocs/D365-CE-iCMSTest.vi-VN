...
ms.locfileid: "385992"
---
# <a name="use-the-early-bound-entity-classes-in-code"></a>Use the early bound entity classes in code
...
## <a name="code-generation-example"></a>Code generation example  
