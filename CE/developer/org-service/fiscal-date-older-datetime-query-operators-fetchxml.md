...
ms.locfileid: "386521"
---
# <a name="fiscal-date-and-older-than-datetime-query-operators-in-fetchxml"></a>Fiscal date and older than datetime query operators in FetchXML
...
<a name="FiscalDate"></a>   
## <a name="using-fetchxml-fiscal-date-conditional-operators"></a>Using FetchXML fiscal date conditional operators  
...
<a name="OlderThan"></a>   
## <a name="using-older-than-clauses-for-date-and-time-values"></a>Using “older than” clauses for date and time values  
