...
ms.locfileid: "385701"
---
# <a name="use-executemultiple-to-improve-performance-for-bulk-data-load"></a>Use ExecuteMultiple to improve performance for bulk data load
...
## <a name="specify-run-time-execution-options"></a>Specify run-time execution options
...
|ExecuteMultipleSettings Member|Mô tả|  
|------------------------------------|-----------------|  
...
|Thiết đặt|Responses Collection Contents|  
|--------------|-----------------------------------|  
...
## <a name="run-time-limitations"></a>Run-time limitations 
...
## <a name="handle-a-batch-size-fault"></a>Handle a batch size fault
