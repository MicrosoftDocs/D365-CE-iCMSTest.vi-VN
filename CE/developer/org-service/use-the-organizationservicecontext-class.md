...
<a name="how_to_use"></a>
## <a name="how-to-use-the-organizationservicecontext-class"></a>How to use the OrganizationServiceContext class  
...
## <a name="track-changes-with-the-organizationservicecontext-class"></a>Track changes with the OrganizationServiceContext class  
...
## <a name="track-related-objects-with-the-organizationservicecontext-class"></a>Track related objects with the OrganizationServiceContext class  
...
### <a name="load-related-entities-using-navigation-properties"></a>Load related entities using navigation properties  
...
## <a name="save-changes-with-the-organizationservicecontext-class"></a>Save changes with the OrganizationServiceContext class  
...
<a name="virtual"></a>   
## <a name="use-virtual-methods-when-the-context-is-changed"></a>Use virtual methods when the context is changed  
