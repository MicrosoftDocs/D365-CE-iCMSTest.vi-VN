...
ms.locfileid: "386201"
---
# <a name="use-messages-request-and-response-classes-with-the-execute-method"></a>Use messages (request and response classes) with the Execute method
...
## <a name="pass-optional-parameters-in-messages"></a>Pass optional parameters in messages  
...
## <a name="execute-messages-in-a-single-database-transaction"></a>Execute messages in a single database transaction  
...
## <a name="execute-messages-in-the-background-asynchronously"></a>Execute messages in the background (asynchronously)
