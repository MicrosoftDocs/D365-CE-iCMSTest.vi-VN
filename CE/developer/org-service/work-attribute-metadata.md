...
ms.locfileid: "387491"
---
# <a name="work-with-attribute-metadata"></a>Work with attribute metadata
...
## <a name="retrieve-an-attribute"></a>Retrieve an attribute  
...
## <a name="create-a-lookup-attribute"></a>Create a lookup attribute  
...
## <a name="insert-a-new-status-value"></a>Insert a new status value  
...
## <a name="update-a-state-value"></a>Update a state value  
...
## <a name="insert-a-new-option-in-a-local-option-set"></a>Insert a new option in a local option set  
...
## <a name="change-the-order-of-options-in-a-local-option-set"></a>Change the order of options in a local option set  
