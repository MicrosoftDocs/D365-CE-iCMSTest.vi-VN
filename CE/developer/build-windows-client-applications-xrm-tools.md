...
ms.locfileid: "387360"
---
# <a name="build-windows-client-applications-using-the-xrm-tools"></a>Build Windows client applications using the XRM tools
...
## <a name="components-of-xrm-tooling"></a>Components of XRM tooling  
...
## <a name="client-applications-that-use-xrm-tooling"></a>Client applications that use XRM tooling  
