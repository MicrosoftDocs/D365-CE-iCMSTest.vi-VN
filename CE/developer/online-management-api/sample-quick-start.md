...
ms.locfileid: "385595"
---
# <a name="quick-start-sample-retrieve-customer-engagement-instances-using-online-management-api"></a>Quick Start Sample: Retrieve Customer Engagement instances using Online Management API 
