...
ms.locfileid: "388825"
---
# <a name="step-4-create-an-appsource-package-for-your-app"></a>Step 4: Create an AppSource package for your app
...
|Tệp HTML|File containing your License terms.|
|input.xml|Files that describes the assets in your AppSource package.|


## <a name="create-a-package-file"></a>Create a Package file
...
## <a name="create-contenttypesxml"></a>Create [Content_Types].xml

You can reuse the **[Content_Types].xml** that you created in the previous section under step 2.

## <a name="create-an-icon-for-your-appsource-package"></a>Create an icon for your AppSource package
...
## <a name="create-an-html-file-for-license-terms"></a>Create an HTML file for license terms
...
## <a name="create-inputxml-file"></a>Create input.xml file
...
## <a name="add-the-items-to-an-appsource-package"></a>Add the items to an AppSource package
