...
ms.locfileid: "386814"
---
# <a name="queue-entities"></a>Queue entities
...
## <a name="members-capabilities"></a>Members capabilities  
...
## <a name="public-and-private-queues"></a>Public and private queues  
...
## <a name="attributes-used-to-manage-queues"></a>Attributes used to manage queues  
 Use the following attributes to manage queues.  
  
|SchemaName|DisplayName|Loại|Mô tả|  
|----------------|-----------------|----------|-----------------|  
|NumberOfItems|Queue Items|Số nguyên|Number of Queue items associated with the queue.|  
|NumberOfMembers|Không. of Members|Số nguyên|Number of Members associated with the queue.|  
|QueueViewType|Loại|Danh sách chọn|Select whether the queue is public or private. A public queue can be viewed by all. A private queue can be viewed only by the members added to the queue.|  
  
<a name="BKMK_deletingQueues"></a>   
## <a name="restrictions-on-deleting-queues"></a>Restrictions on deleting queues  
...
## <a name="enable-entities-for-queues"></a>Enable entities for queues  
...
## <a name="inherit-privileges-and-provide-limited-access-to-a-queue"></a>Inherit privileges and provide limited access to a queue  
...
## <a name="actions-on-queues-and-queue-items"></a>Actions on queues and queue items  
...
### <a name="actions-on-queues"></a>Actions on queues  
...
### <a name="actions-on-queue-items"></a>Actions on queue items  
