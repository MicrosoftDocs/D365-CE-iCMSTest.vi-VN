...
ms.locfileid: "385547"
---
# <a name="application-platform-for-building-extended-xrm-applications"></a>Application platform for building extended xRM applications
...
## <a name="what-does-xrm-mean-for-a-developer"></a>What does xRM mean for a developer?  
...
### <a name="rapid-application-development"></a>Rapid application development  
...
### <a name="you-get-a-user-interface-ready-for-international-use"></a>You get a user interface ready for international use  
...
### <a name="you-get-an-extensible-data-and-security-model"></a>You get an extensible data and security model  
...
### <a name="you-get-extensible-business-logic"></a>You get extensible business logic  
...
### <a name="you-get-includepnmsoffice365includespn-ms-office-365md-integration"></a>You get [!INCLUDE[pn_MS_Office_365](../includes/pn-ms-office-365.md)] integration  
...
### <a name="you-get-cross-platform-mobile-applications"></a>You get cross-platform mobile applications  
...
### <a name="you-get-business-intelligence"></a>You get business intelligence  
...
### <a name="you-can-build-on-top-of-the-platform"></a>You can build on top of the platform  
...
## <a name="learn-more-about-building-extended-includepndynamicscrmincludespn-dynamics-crmmd-xrm-solutions"></a>Learn more about building extended [!INCLUDE[pn_dynamics_crm](../includes/pn-dynamics-crm.md)] (xRM) solutions  
...
- [The metadata and data models in Dynamics 365 for Customer Engagement apps](metadata-data-models.md)  
  ...
  -   [Hướng dẫn nhân viên về các tác vụ thông thường với quy trình](../customize/guide-staff-through-common-tasks-processes.md)   
...
- [Write plug-ins to extend business processes](write-plugin-extend-business-processes.md)  
  ...
  [!INCLUDE[pn_MS_Office_365](../includes/pn-ms-office-365.md)] tích hợp  
