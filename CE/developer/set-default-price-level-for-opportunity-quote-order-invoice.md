...
ms.locfileid: "385934"
---
# <a name="set-default-price-level-for-opportunity-quote-order-and-invoice"></a>Set default price level for opportunity, quote, order, and invoice
...
<a name="Enable"></a>   
## <a name="enable-automatic-selection-of-default-price-level"></a>Enable automatic selection of default price level  
...
<a name="Disable"></a>   
## <a name="disable-automatic-selection-of-default-price-level"></a>Disable automatic selection of default price level  
...
<a name="Extend"></a>   
## <a name="extend-default-price-level-selection"></a>Extend default price level selection  
