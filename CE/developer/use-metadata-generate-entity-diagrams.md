...
ms.locfileid: "386184"
---
# <a name="use-metadata-to-generate-entity-diagrams"></a>Use metadata to generate entity diagrams
...
## <a name="relationships-in-entity-diagrams"></a>Relationships in entity diagrams  
...
|new_bankaccount_Annotations|chú thích|  
...
|new_safedepositbox_Annotations|chú thích|  
...
|------------------------------|-----------------------|  
|lk_new_bankaccount_createdby|người dùng hệ thống|  
|lk_new_bankaccount_createdonbehalfby|người dùng hệ thống|  
|lk_new_bankaccount_modifiedby|người dùng hệ thống|  
|lk_new_bankaccount_modifiedonbehalfby|người dùng hệ thống|  
|user_new_bankaccount|người dùng hệ thống|  
|team_new_bankaccount|nhóm|  
|owner_new_bankaccount|owner|  
|business_unit_new_bankaccount|đơn vị kinh doanh|  
|new_account_new_bankaccount|tài khoản|  
|lk_new_safedepositbox_createdby|người dùng hệ thống|  
|lk_new_safedepositbox_createdonbehalfby|người dùng hệ thống|  
|lk_new_safedepositbox_modifiedby|người dùng hệ thống|  
|lk_new_safedepositbox_modifiedonbehalfby|người dùng hệ thống|  
|user_new_safedepositbox|người dùng hệ thống|  
|team_new_safedepositbox|nhóm|  
|owner_new_safedepositbox|owner|  
|business_unit_new_safedepositbox|đơn vị kinh doanh|  
...
<a name="About"></a>   
## <a name="about-the-diagrams"></a>About the diagrams  
...
<a name="Generate"></a>   
## <a name="generate-entity-diagrams-with-the-metadata-diagram-tool"></a>Generate entity diagrams with the metadata diagram tool  
