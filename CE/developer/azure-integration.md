...
ms.locfileid: "386615"
---
# <a name="azure-integration-with-customer-engagement"></a>Azure integration with Customer Engagement
...
## <a name="key-elements-of-the-connection"></a>Key elements of the connection  
...
## <a name="a-includepndynamicscrmincludespn-dynamics-crmmd-apps-to-service-bus-scenario"></a>A [!INCLUDE[pn_dynamics_crm](../includes/pn-dynamics-crm.md)] apps-to-service bus scenario  
...
## <a name="establish-a-contract-between-includepndynamicscrmincludespn-dynamics-crmmd-apps-and-an-azure-solution"></a>Establish a contract between [!INCLUDE[pn_dynamics_crm](../includes/pn-dynamics-crm.md)] apps and an Azure solution  
...
## <a name="manage-of-run-time-errors"></a>Manage of run-time errors  
