...
ms.locfileid: "386752"
---
# <a name="silverlight-xap-web-resources"></a>Silverlight (XAP) web resources
...
## <a name="creating-silverlight-web-resources"></a>Creating Silverlight web resources  
...
## <a name="accessing-context-data"></a>Accessing context data  
...
## <a name="passing-data-from-a-form-to-an-embedded-silverlight-web-resource"></a>Passing data from a form to an embedded Silverlight web resource  
...
|loại|The entity type code. For custom entities this can vary between organizations.|  
|typename|The logical name of the entity.|  
|orgname|Tên của Tổ chức.|  
...
|dữ liệu|The value of the text entered as a custom parameter.|  
...
## <a name="writing-and-testing-silverlight-web-resources"></a>Writing and testing Silverlight web resources  
...
## <a name="debugging-silverlight-web-resources"></a>Debugging Silverlight web resources  
