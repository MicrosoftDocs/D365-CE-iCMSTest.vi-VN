...
ms.locfileid: "387054"
---
# <a name="data-export-service"></a>Data Export Service
...
## <a name="prerequisites-for-using-the-data-export-service"></a>Prerequisites for using the Data Export Service  
...
## <a name="programming-for-the-data-export-service"></a>Programming for the Data Export Service  
...
### <a name="api-quick-reference"></a>API Quick Reference  
...
|thực thể|[GET](https://discovery.crmreplication.azure.net/swagger/ui/index#/Metadata/Metadata_GetEntities)|Get all exportable public entities for the specified organization|  
...
### <a name="gain-access"></a>Gain Access  
...
### <a name="error-handling-and-failure-processing"></a>Error handling and failure processing  
