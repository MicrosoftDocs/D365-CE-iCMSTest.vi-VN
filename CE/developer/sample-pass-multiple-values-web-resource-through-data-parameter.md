...
ms.locfileid: "386754"
---
# <a name="sample-pass-multiple-values-to-a--web-resource-through-the-data-parameter"></a>Sample: Pass multiple values to a  web resource through the data parameter
...
## <a name="sample-html-web-resource"></a>Sample HTML web resource  
...
#### <a name="using-this-page"></a>Using this page  
...
3.  The `new_/ShowDataParams.htm` will display a dynamically generated table:  
    ...
    |Tham số|Value|  
    |---------------|-----------|  
    |đầu tiên|First Value|  
    |second|Second Value|  
    |third|Third Value|  
  
### <a name="how-it-works"></a>Cách hoạt động  
