...
ms.locfileid: "388098"
---
# <a name="multi-select-picklist-attributes"></a>Multi-Select Picklist attributes
...
## <a name="setting-multi-select-picklist-values"></a>Setting multi-select picklist values
...
## <a name="query-data-from-multi-select-picklists"></a>Query data from multi-select picklists
...
### <a name="multi-select-picklist-sampleoutdooractivities-options"></a>Multi-select picklist `sample_outdooractivities` options:
...
### <a name="contact-entity-values"></a>Contact entity values
...
### <a name="example-code-using-web-api"></a>Example code using Web API
...
### <a name="example-code-using-queryexpression-and-fetchexpression"></a>Example code using QueryExpression and FetchExpression
...
## <a name="create-a-multi-select-picklist-with-code"></a>Create a multi-select picklist with code
