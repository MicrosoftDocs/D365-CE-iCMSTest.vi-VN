...
ms.locfileid: "388169"
---
# <a name="email-activity-entities"></a>Email activity entities
...
<a name="Actions"></a>   
## <a name="actions-on-an-email-activity"></a>Actions on an Email Activity  
...
<a name="BulkE-Mail"></a>   
## <a name="bulk-email"></a>Bulk Email  
...
## <a name="email-attachments"></a>Email Attachments  
...
### <a name="reusing-email-attachments"></a>Reusing Email Attachments  
