...
ms.locfileid: "388088"
---
# <a name="use-an-alternate-key-to-create-a-record"></a>Use an alternate key to create a record
...
## <a name="using-alternate-keys-to-create-an-entity"></a>Using alternate keys to create an entity  
...
## <a name="using-alternate-keys-to-create-an-entityreference"></a>Using alternate keys to create an EntityReference  
...
<a name="BKMK_input"></a>   
## <a name="alternative-input-to-messages"></a>Alternative input to messages  
...
## <a name="exceptions-when-using-alternate-keys"></a>Exceptions when using alternate keys  
