...
ms.locfileid: "386127"
---
# <a name="use-multi-tenant-server-to-server-authentication"></a>Use Multi-Tenant Server-to-server authentication
...
## <a name="overview-develop-and-test-your-application"></a>Overview: Develop and test your application  
...
## <a name="create-a-multi-tenant-web-application-registered-with-your-azure-ad-tenant"></a>Create a multi-tenant web application registered with your Azure AD tenant 
...
## <a name="create-an-application-user--associated-with-the-registered-application--in-includepncrm2016shortestincludespn-crm-2016-shortestmd"></a>Create an application user  associated with the registered application  in [!INCLUDE[pn_crm_2016_shortest](../includes/pn-crm-2016-shortest.md)]  
...
|Tên Sơ đồ|Tên Hiển thị|Loại|Mô tả|  
|-----------------|------------------|----------|-----------------|  
|[Id ứng dụng](entities/systemuser.md#BKMK_ApplicationId)|**Application ID**|UniqueidentifierType|The identifier for the application. This is used to access data in another application.|  
...
### <a name="create-a-security-role-for-the-application-user"></a>Create a security role for the application user  
...
### <a name="manually-create-a-includepncrm2016shortestincludespn-crm-2016-shortestmd-application-user"></a>Manually create a [!INCLUDE[pn_crm_2016_shortest](../includes/pn-crm-2016-shortest.md)] application user  
...
3. Bấm vào **Mới**. Then verify that you are using the **Application user** form.  
...
4. Add the appropriate values to the fields:  
   ...
   |**Họ tên**|The name of your application.|  
   |**Email Chính**|The email address you want your subscribers to use to contact you.|  
...
## <a name="test-your-application-using-your-includepncrm2016shortestincludespn-crm-2016-shortestmd-tenant"></a>Test your application using your [!INCLUDE[pn_crm_2016_shortest](../includes/pn-crm-2016-shortest.md)] tenant 
...
## <a name="test-your-application-using-a-separate-includepncrm2016shortestincludespn-crm-2016-shortestmd-tenant"></a>Test your application using a separate [!INCLUDE[pn_crm_2016_shortest](../includes/pn-crm-2016-shortest.md)] tenant  
...
## <a name="prepare-a-method-to-deploy-the-application-user"></a>Prepare a method to deploy the application user  
...
- [Tạo hoặc chỉnh sửa một vai trò bảo mật](../admin/create-edit-security-role.md)  
- [Sao chép vai trò bảo mật](../admin/copy-security-role.md)  
- [Thêm Thành phần giải pháp](../customize/create-solution.md#add-solution-components)
...
- [Sử dụng các giải pháp cho các tùy chỉnh của bạn](../customize/use-solutions-for-your-customizations.md)  
