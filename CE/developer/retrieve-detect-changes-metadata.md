...
ms.locfileid: "386219"
---
# <a name="retrieve-and-detect-changes-to-metadata"></a>Retrieve and detect changes to metadata
...
## <a name="strategies-for-using-metadata"></a>Strategies for using metadata  
...
### <a name="lightweight-query"></a>Lightweight query
...
### <a name="persistent-metadata-cache"></a>Persistent metadata cache
...
## <a name="retrieve-only-the-metadata-you-need"></a>Retrieve only the metadata you need  
...
### <a name="specify-your-filter-criteria"></a>Specify your filter criteria  
...
### <a name="specify-the-properties-you-want"></a>Specify the properties you want
...
### <a name="retrieve-attribute-metadata"></a>Retrieve attribute metadata 
...
### <a name="retrieve-relationship-metadata"></a>Retrieve relationship metadata
...
### <a name="retrieve-labels"></a>Retrieve labels
...
## <a name="retrieve-new-or-changed-metadata"></a>Retrieve new or changed metadata
...
## <a name="retrieve-information-about-deleted-metadata"></a>Retrieve information about deleted metadata  
...
### <a name="deleted-metadata-expiration"></a>Deleted metadata expiration  
...
### <a name="performance-when-retrieving-deleted-metadata"></a>Performance when retrieving deleted metadata 
