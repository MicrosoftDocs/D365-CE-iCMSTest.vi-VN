...
ms.locfileid: "388555"
---
# <a name="use-change-tracking-to-synchronize-data-with-external-systems"></a>Use change tracking to synchronize data with external systems
...
## <a name="enable-change-tracking-for-an-entity"></a>Enable change tracking for an entity  
...
## <a name="retrieve-changes-for-an-entity-using-the-web-api"></a>Retrieve changes for an entity using the Web API  
...
## <a name="retrieve-changes-in-entities-using-web-api-example"></a>Retrieve changes in entities using Web API example
...
<a name="bkmk_count"></a>
## <a name="retrieve-count-of-the-changes-made-in-entities-using-web-api"></a>Retrieve count of the changes made in entities using Web API
...
## <a name="query-options-not-supported-in-change-tracking-web-api-request"></a>Query options not supported in Change Tracking Web API request
...
## <a name="retrieve-changes-for-an-entity-using-the-organization-service"></a>Retrieve changes for an entity using the Organization Service
