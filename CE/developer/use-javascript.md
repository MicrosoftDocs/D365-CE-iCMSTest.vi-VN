...
ms.locfileid: "386242"
---
# <a name="use-javascript-with-customer-engagement-apps"></a>Use JavaScript with Customer Engagement apps
...
## <a name="areas-where-you-can-use-javascript-in-dynamics-365-for-customer-engagement-apps"></a>Areas where you can use JavaScript in Dynamics 365 for Customer Engagement apps
...
### <a name="form-scripts"></a>Mã lệnh biểu mẫu  
...
### <a name="command-bar-ribbon-commands"></a>Command bar (ribbon) commands  
...
## <a name="use-of-jquery"></a>Use of jQuery  
...
## <a name="write-javascript-for-multiple-browsers"></a>Write JavaScript for multiple browsers  
...
## <a name="javascript-programming-best-practices"></a>JavaScript programming best practices  
...
### <a name="use-a-cross-browser-javascript-library-for-html-web-resource-user-interfaces"></a>Use a cross-browser JavaScript library for HTML web resource user interfaces  
...
### <a name="do-not-use-jquery-for-form-script-or-commands"></a>Do not use jQuery for form script or commands
...
### <a name="recognize-limitations-for-content-delivery-network-cdn-libraries"></a>Recognize limitations for content delivery network (CDN) libraries
...
### <a name="use-feature-detection-when-writing-functions-for-multiple-browsers"></a>Use feature detection when writing functions for multiple browsers
...
### <a name="do-not-access-the-dom"></a>Do not access the DOM
...
### <a name="define-unique-names-for-your-javascript-functions"></a>Define unique names for your JavaScript functions
...
### <a name="use-asynchronous-data-access-methods"></a>Use asynchronous data access methods
