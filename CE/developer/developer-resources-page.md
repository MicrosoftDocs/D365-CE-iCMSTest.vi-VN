...
ms.locfileid: "388416"
---
# <a name="developer-resources-page"></a>Developer resources page 
...
## <a name="organization-unique-name"></a>Organization unique name  
...
## <a name="microsoft-azure-service-bus-issuer-certificate"></a>Microsoft Azure Service Bus issuer certificate  
...
### <a name="for-includepndynamicscrmonlineincludespn-dynamics-crm-onlinemd-apps"></a>For [!INCLUDE[pn_dynamics_crm_online](../includes/pn-dynamics-crm-online.md)] apps
...
### <a name="for-on-premises-includepndynamicscrmincludespn-dynamics-crmmd-apps"></a>For on-premises [!INCLUDE[pn_dynamics_crm](../includes/pn-dynamics-crm.md)] apps
...
|Khu vực| URL|
|---|---|
|Bắc Mỹ|`https://OrganizationName.api.crm.dynamics.com/XrmServices/2011/Organization.svc`|
|North America 2|`https://OrganizationName.api.crm9.dynamics.com/XrmServices/2011/Organization.svc`|
|Nam Mỹ|`https://OrganizationName.api.crm2.dynamics.com/XrmServices/2011/Organization.svc`|
...
|Châu Đại Dương|`https://OrganizationName.api.crm6.dynamics.com/XrmServices/2011/Organization.svc`|
|Nhật Bản|`https://OrganizationName.api.crm7.dynamics.com/XrmServices/2011/Organization.svc`|
|Ấn Độ|`https://OrganizationName.api.crm8.dynamics.com/XrmServices/2011/Organization.svc`|
...
## <a name="organization-data-service"></a>Organization data service  
...
|Khu vực| URL|
|---|---|
|Bắc Mỹ|`https://OrganizationName.api.crm.dynamics.com/XrmServices/2011/OrganizationData.svc`|
|North America 2|`https://OrganizationName.api.crm9.dynamics.com/XrmServices/2011/OrganizationData.svc`|
|Nam Mỹ|`https://OrganizationName.api.crm2.dynamics.com/XrmServices/2011/OrganizationData.svc`|
...
|Châu Đại Dương|`https://OrganizationName.api.crm6.dynamics.com/XrmServices/2011/OrganizationData.svc`|
|Nhật Bản|`https://OrganizationName.api.crm7.dynamics.com/XrmServices/2011/OrganizationData.svc`|
|Ấn Độ|`https://OrganizationName.api.crm8.dynamics.com/XrmServices/2011/OrganizationData.svc`|
...
## <a name="using-the-wsdl"></a>Using the WSDL
