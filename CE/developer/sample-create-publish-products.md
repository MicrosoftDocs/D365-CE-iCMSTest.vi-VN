...
search.app:
- D365CE
ms.openlocfilehash: 29f5f76858f32d973f95f999a5f838bd6840aadc
...
ms.locfileid: "388750"
---
# <a name="sample-create-and-publish-products"></a><span data-ttu-id="b0414-103">Sample: Create and publish products</span><span class="sxs-lookup"><span data-stu-id="b0414-103">Sample: Create and publish products</span></span>

[!INCLUDE[](../includes/cc_applies_to_update_9_0_0.md)]

<span data-ttu-id="b0414-104">This sample code is for [!INCLUDE[pn_dynamics_crm_online](../includes/pn-dynamics-crm-online.md)].</span><span class="sxs-lookup"><span data-stu-id="b0414-104">This sample code is for [!INCLUDE[pn_dynamics_crm_online](../includes/pn-dynamics-crm-online.md)].</span></span> <span data-ttu-id="b0414-105">[Download the Product Catalog samples](https://code.msdn.microsoft.com/Product-Catalog-Samples-5766194b).</span><span class="sxs-lookup"><span data-stu-id="b0414-105">[Download the Product Catalog samples](https://code.msdn.microsoft.com/Product-Catalog-Samples-5766194b).</span></span>    

## <a name="prerequisites"></a><span data-ttu-id="b0414-106">Điều kiện tiên quyết</span><span class="sxs-lookup"><span data-stu-id="b0414-106">Prerequisites</span></span>
[!INCLUDE[sdk-prerequisite](../includes/sdk-prerequisite.md)]
  
## <a name="requirements"></a><span data-ttu-id="b0414-107">Yêu cầu</span><span class="sxs-lookup"><span data-stu-id="b0414-107">Requirements</span></span>  
[!INCLUDE[sdk_SeeConnectionHelper](../includes/sdk-seeconnectionhelper.md)]
  
## <a name="demonstrates"></a><span data-ttu-id="b0414-108">Chứng tỏ</span><span class="sxs-lookup"><span data-stu-id="b0414-108">Demonstrates</span></span>  
 <span data-ttu-id="b0414-109">This sample shows how to:</span><span class="sxs-lookup"><span data-stu-id="b0414-109">This sample shows how to:</span></span>  
  
-   <span data-ttu-id="b0414-110">Create a product family, product property, and child products.</span><span class="sxs-lookup"><span data-stu-id="b0414-110">Create a product family, product property, and child products.</span></span>  
  
-   <span data-ttu-id="b0414-111">Override a product property at a child product level.</span><span class="sxs-lookup"><span data-stu-id="b0414-111">Override a product property at a child product level.</span></span>  
  
-   <span data-ttu-id="b0414-112">Publish the product hierarchy.</span><span class="sxs-lookup"><span data-stu-id="b0414-112">Publish the product hierarchy.</span></span>  
  
-   <span data-ttu-id="b0414-113">Revise a child product to overwrite the overridden property.</span><span class="sxs-lookup"><span data-stu-id="b0414-113">Revise a child product to overwrite the overridden property.</span></span>  
  
## <a name="example"></a><span data-ttu-id="b0414-114">Ví dụ</span><span class="sxs-lookup"><span data-stu-id="b0414-114">Example</span></span>  
...
### <a name="see-also"></a><span data-ttu-id="b0414-115">Xem thêm</span><span class="sxs-lookup"><span data-stu-id="b0414-115">See also</span></span>  
 <span data-ttu-id="b0414-116">[Create and manage product families, products and bundles](create-manage-product-families-products-bundles-product-properties.md) </span><span class="sxs-lookup"><span data-stu-id="b0414-116">[Create and manage product families, products and bundles](create-manage-product-families-products-bundles-product-properties.md) </span></span>  
 <span data-ttu-id="b0414-117">[Publish, revise, revert, retire, and activate products (product lifecycle)](publish-revise-revert-retire-activate-products.md) </span><span class="sxs-lookup"><span data-stu-id="b0414-117">[Publish, revise, revert, retire, and activate products (product lifecycle)](publish-revise-revert-retire-activate-products.md) </span></span>  
 [<span data-ttu-id="b0414-118">Product catalog entities</span><span class="sxs-lookup"><span data-stu-id="b0414-118">Product catalog entities</span></span>](product-catalog-entities.md)
