...
ms.locfileid: "387081"
---
# <a name="create-patches-to-simplify-solution-updates"></a>Create patches to simplify solution updates
...
## <a name="create-a-patch"></a>Create a patch  
...
## <a name="export-and-import-a-patch"></a>Export and import a patch  
...
### <a name="patching-examples"></a>Patching examples  
...
### <a name="another-patching-example"></a>Another patching example  
...
## <a name="delete-a-patch"></a>Delete a patch  
...
## <a name="update-a-solution"></a>Update a solution  
...
### <a name="see-also"></a>Xem thêm  
 [Sử dụng các bản vá lỗi và giải pháp phân khúc để đơn giản hóa các bản cập nhật giải pháp](https://technet.microsoft.com/library/mt628808.aspx)   
