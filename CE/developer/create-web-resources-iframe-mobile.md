...
ms.locfileid: "387732"
---
# <a name="create-web-resources-and-iframe-content-for-use-with-the-dynamics-365-for-customer-engagement-apps-for-mobile-clients"></a>Create web resources and IFrame content for use with the Dynamics 365 for Customer Engagement apps for mobile clients
...
## <a name="configure-a-web-resource-to-be-displayed-in-mobile-clients"></a>Configure a web resource to be displayed in mobile clients  
...
> [!NOTE]
> If your **Webpage (HTML)** web resources reference on any other type of web resource which is not enabled for offline use, you must set those web resources as dependences for the HTML web resource so that they will be enabled for use offline. Thông tin khác: [Quan hệ phụ thuộc tài nguyên web](web-resource-dependencies.md)
  
<a name="BKMK_ConfigureControl"></a>

## <a name="configure-a-form-or-dashboard-iframe-or-web-resource-control-to-display-in-dynamics-365-for-customer-engagement-apps-for-mobile-clients"></a>Configure a form or dashboard IFrame or web resource control to display in Dynamics 365 for Customer Engagement apps for mobile clients  

When you add an IFrame or a web resource to a form or dashboard, you must select the **Enable for mobile** check box in the **Add Web Resource** dialog box. This sets the `<ShowOnMobileClient>` parameter value for the control.  
...
- Xác thực cho các trang web [!INCLUDE[pn_Office_365](../includes/pn-office-365.md)] được nhúng không có sẵn.    
...
[Quan hệ phụ thuộc tài nguyên web](web-resource-dependencies.md)<br />
