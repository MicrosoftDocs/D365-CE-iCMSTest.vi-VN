...
ms.locfileid: "385742"
---
# <a name="how-to-enable-outbound-communication-clicktoact-in-channel-integration-framework"></a>How to enable outbound communication (ClickTOAct) in Channel Integration Framework?
...
## <a name="step-1-set-the-enable-outbound-communication-field-value-in-the-channel-provider-configuration"></a>Step 1: Set the Enable Outbound Communication field value in the channel provider configuration
...
## <a name="step-2-add-the-channel-communication-control-to-the-unified-interface-form"></a>Step 2: Add the Channel Communication Control to the Unified Interface form
...
2. Chuyển tới **Thiết đặt** > **Tùy chỉnh**.
...
## <a name="step-3-register-the-addhandler-in-javascript-code-using-the-onclicktoact-event"></a>Step 3: Register the addHandler in JavaScript code using the onclicktoact event
