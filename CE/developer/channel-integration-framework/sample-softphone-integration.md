...
ms.locfileid: "387679"
---
# <a name="sample-softphone-integration-using-channel-integration-framework"></a>Sample softphone integration using Channel Integration Framework
...
## <a name="pre-requisites"></a>Điều kiện tiên quyết
...
## <a name="publish-sample-app-to-azure"></a>Publish sample app to Azure
...
9. Select *Create* to create the azure app service, and save the app service URL for future use.<br>Ví dụ, `https://sampleinteg.azurewebsites.net`.

## <a name="create-function-to-use-with-the-app-service"></a>Create function to use with the app service
...
## <a name="configure-sample-app-in-dynamics-365"></a>Configure sample app in Dynamics 365

1. Note the base URL of the CRM org from where all webresources are served. For an online org, this should be of the form `https://<orgname>.crmXX.dynamics.com`. Ví dụ: `https://sampleorg.crm10.dynamics.com`
...
2. Configure the channel provider by providing the detail as show in the matrix. For more information, see [Configure the channel provider](configure-channel-provider-channel-integration-framework.md)
  ...
  | Trường | Mô tả |
  |-------|-------|
  |Tên|Name of the channel provider.<br><br> Example: Contoso|
  |Nhãn|The label is displayed as the title on the widget.<br><br> Example: Contoso|
  ...
  |Enable Outbound Communication| Có |
  |Channel Order| 0 |
  |API Version| 1.0 |
...
- [Tham chiếu thực thể](reference/entities-attributes/msdyn-ciprovider.md)