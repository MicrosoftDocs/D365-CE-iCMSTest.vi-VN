...
ms.locfileid: "386001"
---
# <a name="add-transformation-mappings-for-import"></a>Add transformation mappings for import
...
|Input Parameters|Mô tả|  
|----------------------|-----------------|  
|Tiền tố|String that is used as a prefix in the concatenated string.|  
...
|Output Parameters|Mô tả|  
|-----------------------|-----------------|  
|Chuỗi|Concatenated string.|  
...
|Độ dài|Length of the substring. If the length is **null**, returns a complete string from the start index.|  
...
## <a name="assign-value"></a>Assign value  
...
## <a name="add-to-date"></a>Add to date  
...
## <a name="adjust-current-date-and-set-time"></a>Adjust current date and set time  
...
|Giờ|Value that is used to set the hours component of a current date.|  
...
## <a name="advanced-add-to-current-date"></a>Advanced add to current date  
...
|       Giờ       |                                                                                                                                                                                   Value that sets the hours component of a current date.                                                                                                                                                                                    |
