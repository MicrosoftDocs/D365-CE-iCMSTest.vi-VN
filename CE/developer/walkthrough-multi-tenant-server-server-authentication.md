...
ms.locfileid: "388381"
---
# <a name="walkthrough-multi-tenant-server-to-server-authentication"></a>Walkthrough: Multi-tenant server-to-server authentication
...
## <a name="goal-of-this-walkthrough"></a>Goal of this walkthrough
...
## <a name="verify-azure-ad-tenant"></a>Verify Azure AD tenant
...
## <a name="create-an-mvc-web-application"></a>Create an MVC web application
...
## <a name="register-your-application-on-azure-ad"></a>Register your application on Azure AD
...
## <a name="create-an-application-user"></a>Tạo người dùng ứng dụng
...
## <a name="add-assemblies"></a>Add Assemblies  

 Add the following [!INCLUDE[tn_nuget](../includes/tn-nuget.md)] packages to your project  
  
|Package|Phiên bản|  
|-------------|-------------|  
|Microsoft.CrmSdk.CoreAssemblies|Phiên bản mới nhất|  
...
## <a name="apply-code-changes-to-the-mvc-template"></a>Apply code changes to the MVC template
...
### <a name="controllershomecontrollercs"></a>Controllers/HomeController.cs
...
### <a name="viewssharedlayoutcshtml"></a>Views/Shared/_Layout.cshtml  
...
### <a name="appstartstartupauthcs"></a>App_Start/Startup.Auth.cs  
...
### <a name="add-controllerscrmsdkcontroller"></a>Add Controllers/CrmSdkController  
...
### <a name="viewscrmsdk"></a>Views/CrmSdk
...
## <a name="debug-the-app"></a>Debug the app
...
## <a name="configure-test-subscriber"></a>Configure test subscriber
...
### <a name="give-consent-from-the-subscribing-tenant"></a>Give consent from the subscribing tenant
...
### <a name="create-the-subscriber-application-user"></a>Create the subscriber application user
...
### <a name="test-the-subscriber-connection"></a>Test the subscriber connection
