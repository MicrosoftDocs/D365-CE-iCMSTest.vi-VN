...
ms.locfileid: "387068"
---
# <a name="understand-the-data-context-passed-to-a-plug-in"></a>Understand the data context passed to a plug-in
...
## <a name="access-the-plug-in-execution-context"></a>Access the plug-in execution context
...
## <a name="access-the-organization-service"></a>Access the Organization service 
...
## <a name="access-the-notification-service"></a>Access the Notification service  
...
## <a name="input-and-output-parameters"></a>Input and output parameters
...
## <a name="pre-and-post-entity-images"></a>Pre and post entity images
...
|Message Request|Thuộc tính|Mô tả|  
|---------------------|--------------|-----------------|  
|<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|Đích|The assigned entity.|  
|<xref:Microsoft.Xrm.Sdk.Messages.CreateRequest>|Đích|The created entity.|  
|<xref:Microsoft.Xrm.Sdk.Messages.DeleteRequest>|Đích|The deleted entity.|  
...
|<xref:Microsoft.Crm.Sdk.Messages.ExecuteWorkflowRequest>|Đích|The workflow entity.|  
|<xref:Microsoft.Crm.Sdk.Messages.MergeRequest>|Đích|The parent entity, into which the data from the child entity is being merged.|  
...
|<xref:Microsoft.Xrm.Sdk.Messages.UpdateRequest>|Đích|The updated entity.|  
