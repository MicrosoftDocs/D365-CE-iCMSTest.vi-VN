...
ms.locfileid: "388300"
---
# <a name="open-forms-views-and-dashboards-in-customer-engagement-mobile-client-with-a-url"></a>Open forms, views, and dashboards in Customer Engagement mobile client with a URL
...
## <a name="query-string-parameters-for-the-url"></a>Query string parameters for the URL
