...
ms.locfileid: "386677"
---
# <a name="introduction-to-solutions"></a>Introduction to solutions
...
## <a name="extensibility-choices"></a>Extensibility choices  
...
## <a name="solution-components"></a>Thành phần giải pháp
...
## <a name="unmanaged-and-managed-solutions"></a>Unmanaged and managed solutions  
 ...
 ![Phân lớp giải pháp](media/solution-layering.png "Phân lớp giải pháp")  
...
### <a name="unmanaged-solutions"></a>Giải pháp không được quản lý  
...
#### <a name="importing-unmanaged-solutions"></a>Importing unmanaged solutions  
...
#### <a name="unmanaged-customizations"></a>Unmanaged customizations  
...
##### <a name="solution-publisher-for-unmanaged-solutions"></a>Solution publisher for unmanaged solutions  
...
### <a name="managed-solutions"></a>Các giải pháp được quản lý  
...
#### <a name="solution-publisher-for-managed-solutions"></a>Solution publisher for managed solutions  
...
## <a name="managed-properties"></a>Thuộc tính được quản lý  
...
### <a name="conflict-resolution-on-the-update-of-a-managed-solution"></a>Conflict resolution on the update of a managed solution  
...
## <a name="support-for-multiple-languages"></a>Support for multiple languages  
