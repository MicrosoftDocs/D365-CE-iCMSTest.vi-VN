...
ms.locfileid: "385926"
---
# <a name="work-with-customer-engagement-event-data-in-your-azure-event-hub-solution"></a>Work with Customer Engagement event data in your Azure Event Hub solution
...
## <a name="1-create-an-event-hub"></a>1. Create an event hub  
...
## <a name="2-register-an-endpoint"></a>2. Register an endpoint  
...
## <a name="3-register-code"></a>3. Register code  
...
## <a name="6-verification"></a>6. Verification  
