...
ms.locfileid: "385879"
---
# <a name="developer-guide-for-dynamics-365-for-customer-engagement-apps"></a>Developer Guide for Dynamics 365 for Customer Engagement apps
...
<li><a href="audit-entity-data-changes.md" data-raw-source="[Audit data changes](audit-entity-data-changes.md)">Kiểm tra những thay đổi về dữ liệu</a></li>
<li><a href="detect-duplicate-data-for-developers.md" data-raw-source="[Detect duplicate data](detect-duplicate-data-for-developers.md)">Phát dữ liệu trùng lặp</a></li>
<li><a href="import-data.md" data-raw-source="[Import data](import-data.md)">Nhập dữ liệu</a></li>
<li><a href="virtual-entities/get-started-ve.md" data-raw-source="[Virtual entities](virtual-entities/get-started-ve.md)">Thực thể ảo</a></li>
</td>
<td>
<h2> Use web services</h2>

<li><a href="use-microsoft-dynamics-365-web-api.md" data-raw-source="[Web API](use-microsoft-dynamics-365-web-api.md)">API Web</a></li>
...
<li><a href="online-management-api.md" data-raw-source="[Online Management API](online-management-api.md)">API Quản lý Trực tuyến</a></li>
</td>
</tr>
...
<li><a href="write-plugin-extend-business-processes.md" data-raw-source="[Plug-ins](write-plugin-extend-business-processes.md)">Phần bổ trợ</a></li>
<li><a href="automate-business-processes-customer-engagement.md" data-raw-source="[Automate business processes](automate-business-processes-customer-engagement.md)">Quy trình công việc tự động</a></li>
...
<li><a href="customize-dev/customize-entity-views.md" data-raw-source="[Entity views](customize-dev/customize-entity-views.md)">Dạng xem thực thể</a></li>
...
<li><a href="package-distribute-extensions-use-solutions.md" data-raw-source="[Use solutions](package-distribute-extensions-use-solutions.md)">Sử dụng các giải pháp</a></li>
...
<td>
<h2> Tham chiếu chương trình </h2>

<li><a href="about-entity-reference.md" data-raw-source="[Entity Reference](about-entity-reference.md)">Tham chiếu Thực thể</a></li>
<li><a href="/dynamics365/customer-engagement/web-api/about" data-raw-source="[Web API Reference](/dynamics365/customer-engagement/web-api/about)">Tham chiếu API Web</a></li>
...
[Hướng dẫn cho Quản trị viên](../admin/admin-guide.md)

[Hướng dẫn Tùy chỉnh](../customize/overview.md)
