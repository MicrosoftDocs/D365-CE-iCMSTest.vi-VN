...
ms.locfileid: "385593"
---
# <a name="retrieve-and-delete-the-history-of-audited-data-changes"></a>Retrieve and delete the history of audited data changes
...
## <a name="retrieve-the-change-history"></a>Retrieve the change history 
...
## <a name="delete-the-change-history-for-a-record"></a>Delete the change history for a record
...
## <a name="delete-the-change-history-for-a-date-range"></a>Delete the change history for a date range
...
### <a name="see-also"></a>Xem thêm
 ...
 [Kiểm tra truy cập người dùng](audit-user-access.md) <br />
