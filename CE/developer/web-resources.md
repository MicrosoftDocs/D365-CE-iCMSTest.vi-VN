...
ms.locfileid: "387387"
---
# <a name="web-resources-for-customer-engagement"></a>Web resources for Customer Engagement
...
## <a name="capabilities-of-web-resources"></a>Capabilities of web resources  
...
### <a name="limitations-of-web-resources"></a>Limitations of web resources  
...
|                                    File                                     | File extensions | Loại |
|-----------------------------------------------------------------------------|-----------------|------|
|                               Trang web (HTML)                                |   .htm, .html   |  1   |
|                              Tờ mẫu (CSS)                              |      .css       |  2   |
|                              Mã lệnh (JScript)                               |       .js       |  3   |
|                                 Dữ liệu (XML)                                  |      .xml       |  4   |
|                                 Hình ảnh (PNG)                                 |      .png       |  5   |
|                                 Hình ảnh (JPG)                                 |      .jpg       |  6   |
|                                 Hình ảnh (GIF)                                 |      .gif       |  7   |
...
## <a name="reference-web-resources"></a>Reference web resources  
...
### <a name="webresource-directive"></a>$webresource directive  
...
**WebResources Manager** is a tool that XrmToolbox community developed for [!INCLUDE[pn_dynamics_crm](../includes/pn-dynamics-crm.md)] Customer Engagement. Vui lòng xem chủ đề [Công cụ dành cho nhà phát triển](developer-tools.md) về các công cụ được cộng đồng phát triển.
