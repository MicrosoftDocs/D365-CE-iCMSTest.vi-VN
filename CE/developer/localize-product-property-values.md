...
ms.locfileid: "387916"
---
# <a name="localize-product-property-values"></a>Localize product property values
...
## <a name="attributes-that-support-localized-property-values"></a>Attributes that support localized property values  
...
## <a name="retrieve-localized-property-values"></a>Retrieve localized property values  
...
<a name="BKMK_Query"></a>   
## <a name="query-using-localized-values"></a>Query using localized values  
...
## <a name="create-or-update-records-with-localizable-attributes"></a>Create or update records with localizable attributes  
...
## <a name="translate-localizable-attributes"></a>Translate localizable attributes  
...
### <a name="modify-the-values-included-when-exporting-translated-property-values"></a>Modify the values included when exporting translated property values  
...
|Thực thể|`SavedQueryId`|Default `FetchXml`|  
|------------|--------------------|------------------------|  
|sản phẩm|9cfe2a9f-13c4-e311-8f2e-00155d9d2505|<fetch version="1.0"<br /> output-format="xml-platform"<br /> mapping="logical"<br /> distinct="false"><br /> \<entity name="product"><br /> \<attribute name="name" /><br /> \</entity><br />\</fetch>|  
|thuộc tính dynamic|4833cf48-1ac4-e311-8f2e-00155d9d2505|<fetch version="1.0"<br /> output-format="xml-platform"<br /> mapping="logical"><br /> \<entity name="dynamicproperty"><br /> \<attribute name="name" /><br /> \</entity><br />\</fetch>|  
...
### <a name="monitor-the-progress-of-field-translation-import-jobs"></a>Monitor the progress of field translation import jobs  
...
## <a name="uninstall-a-language"></a>Uninstall a language  
...
### <a name="see-also"></a>Xem thêm  
 ...
 [Dịch tên sản phẩm và thuộc tính sang nhiều ngôn ngữ](http://go.microsoft.com/fwlink/p/?LinkId=512440)
