...
ms.locfileid: "387959"
---
# <a name="use-editable-grids-in-customer-engagement"></a>Use editable grids in Customer Engagement
...
> [!NOTE] 
> If you are using legacy forms (versions prior to Dynamics CRM 2016) and enable an editable grid on a subgrid, the editable subgrid will not be rendered. Quản trị viên hệ thống có thể tắt các biểu mẫu cũ trong thiết đặt hệ thống nếu cần thiết. 
...
## <a name="form-scripting-support"></a>Form scripting support  
...
## <a name="entities-and-views-supported-by-editable-grid"></a>Entities and views supported by editable grid  
...
## <a name="frequently-asked-questions-faqs"></a>Câu hỏi thường gặp (FAQ)
...
### <a name="see-also"></a>Xem thêm  
 ...
 [Để lưới (danh sách) có thể chỉnh sửa được, hãy sử dụng kiểm soát tùy chỉnh Lưới có thể chỉnh sửa](../../customize/make-grids-lists-editable-custom-control.md)<br/>
 [Sử dụng phím tắt trong lưới có thể chỉnh sửa](../../basics/keyboard-shortcuts.md#editable-grids-views)
