...
ms.locfileid: "386371"
---
# <a name="export-prepare-to-edit-and-import-the-ribbon"></a>Export, prepare to edit, and import the ribbon
...
## <a name="export-the-ribbon"></a>Export the ribbon  
...
#### <a name="create-a-new-solution"></a>Tạo một giải pháp mới  
...
#### <a name="use-an-existing-solution"></a>Use an existing solution  
...
5. If you have made recent changes that have not yet been published, click **Publish All Customizations**. Nếu không, bấm vào **Tiếp tục**.  
...
## <a name="prepare-to-edit-the-xml"></a>Prepare to edit the XML  
...
## <a name="import-the-ribbon"></a>Import the ribbon  
...
9. After the import has finished, you will see the message indicating that the import completed successfully. Bấm vào Đóng.  
...
### <a name="dealing-with-errors-on-import"></a>Dealing with errors on import  
