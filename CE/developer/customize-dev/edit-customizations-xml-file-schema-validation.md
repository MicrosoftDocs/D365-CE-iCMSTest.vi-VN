...
ms.locfileid: "387564"
---
# <a name="edit-the-customizations-xml-file-with-schema-validation"></a>Edit the customizations XML file with schema validation
...
## <a name="xsd-schema-files"></a>XSD schema files  
...
## <a name="using-schema-validation"></a>Using schema validation  
...
### <a name="see-also"></a>Xem thêm
 ...
 [Ribbon core schema](ribbon-core-schema.md) [Ribbon types schema](ribbon-types-schema.md) [Ribbon WSS schema](ribbon-wss-schema.md) [SiteMap schema](sitemap-schema.md)   
