...
ms.locfileid: "385538"
---
# <a name="define-ribbon-enable-rules"></a>Define ribbon enable rules
...
## <a name="what-does-enabled-mean"></a>What does enabled mean?  
...
## <a name="control-when-ribbon-elements-are-enabled"></a>Control when ribbon elements are enabled  
...
### <a name="command-client-type-rule"></a>Command Client Type Rule
...
### <a name="crm-client-type-rule"></a>Crm Client Type Rule
...
### <a name="crm-offline-access-state-rule"></a>Crm Offline Access State Rule
...
### <a name="crm-outlook-client-type-rule"></a>Crm Outlook Client Type Rule
...
### <a name="custom-rule"></a>Custom Rule
...
### <a name="entity-rule"></a>Entity Rule
...
### <a name="form-state-rule"></a>Form State Rule
...
### <a name="outlook-item-tracking-rule"></a>Outlook Item Tracking Rule
...
### <a name="outlook-version-rule"></a>Outlook Version Rule
...
### <a name="record-privilege-rule"></a>Record Privilege Rule
...
### <a name="selection-count-rule"></a>Selection Count Rule
...
### <a name="value-rule"></a>Value Rule
