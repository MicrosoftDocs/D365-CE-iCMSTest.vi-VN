...
ms.locfileid: "387128"
---
# <a name="when-to-edit-the-customizations-file"></a>When to edit the customizations file
...
## <a name="unsupported-tasks"></a>Unsupported tasks  
...
### <a name="see-also"></a>Xem thêm  
 ...
 [Ribbon core schema](ribbon-core-schema.md) [Ribbon types schema](ribbon-types-schema.md) [Ribbon WSS schema](ribbon-wss-schema.md)   
