...
ms.locfileid: "388150"
---
# <a name="sample-charts"></a>Sample charts
...
## <a name="column-chart"></a>Column Chart  
...
### <a name="presentation-description"></a>Presentation Description  
...
## <a name="multi-series-chart"></a>Multi-Series Chart  
...
## <a name="comparison-chart-stacked-chart"></a>Comparison Chart (Stacked Chart)  
...
## <a name="comparison-chart-100-stacked-chart"></a>Comparison Chart (100% Stacked Chart)  
