...
ms.locfileid: "385481"
---
# <a name="service-calendar-appearance-configuration"></a>Service calendar appearance configuration
...
## <a name="set-time-block-appearance"></a>Set time block appearance  
...
## <a name="set-smooth-scroll-limit"></a>Set smooth scroll limit  
 ...
 Giá trị mặc định là 2000. You must edit the value, and the re-import and publish the solution before the change will take effect.  
  
<a name="BKMK_ValidationChunkSize"></a>   
## <a name="set-validation-chunk-size"></a>Set validation chunk size  
...
## <a name="export-the-isvconfig"></a>Export the ISV.Config  
