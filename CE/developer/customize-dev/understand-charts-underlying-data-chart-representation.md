...
ms.locfileid: "386287"
---
# <a name="understand-charts-underlying-data-and-chart-representation"></a>Understand charts: Underlying data and chart representation
...
## <a name="use-the-data-description-xml-string-to-specify-chart-data"></a>Use the data description XML string to specify chart data  
...
### <a name="the-fetchcollection-element"></a>The \<FetchCollection> element  
...
### <a name="the-categorycollection-element"></a>The \<CategoryCollection> element  
...
## <a name="use-the-presentation-description-xml-string-to-specify-data-representation"></a>Use the presentation description XML string to specify data representation  
