...
ms.locfileid: "387308"
---
# <a name="introduction-to-entity-attributes"></a>Introduction to entity attributes
...
## <a name="valid-operations-on-attributes"></a>Valid operations on attributes  
...
|AttributeMetadata property|Mô tả|  
|--------------------------------|-----------------|  
...
## <a name="types-of-attributes"></a>Types of attributes  
...
## <a name="categorization-data-attributes"></a>Categorization data attributes  
...
|                         Metadata Type                         | AttributeTypeName Value |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      Mô tả                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|---------------------------------------------------------------|-------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
## <a name="collection-data-attributes"></a>Collection data attributes  
 These system attributes return collections of values.  

|AttributeTypeName Value|Mô tả|  
|-----------------------------|-----------------|  
...
## <a name="date-and-time-data-attribute"></a>Date and time data attribute  
...
<a name="BKMK_Image"></a>   
## <a name="image-data-attributes"></a>Image data attributes  
...
## <a name="quantity-data-attributes"></a>Quantity data attributes  
...
## <a name="reference-data-attributes"></a>Reference data attributes  
...
## <a name="string-data-attributes"></a>String data attributes  
...
## <a name="unique-identifier-data-attributes"></a>Unique identifier data attributes  
...
## <a name="virtual-attributes"></a>Virtual attributes  
...
## <a name="logical-attributes"></a>Logical attributes  
