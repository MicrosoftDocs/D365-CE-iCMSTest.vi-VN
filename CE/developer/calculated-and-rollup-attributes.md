...
ms.locfileid: "385963"
---
# <a name="calculated-and-rollup-attributes"></a>Calculated and rollup attributes
...
## <a name="common-elements-and-characteristics"></a>Common elements and characteristics  
...
## <a name="calculated-attributes"></a>Calculated attributes  
...
## <a name="rollup-attributes"></a>Rollup attributes  
...
### <a name="rollup-state-values"></a>Rollup state values  
...
### <a name="retrieve-a-calculated-rollup-field-value-immediately"></a>Retrieve a calculated rollup field value immediately  
...
### <a name="see-also"></a>Xem thêm  
 ...
 [Xác định trường tính toán](https://technet.microsoft.com/library/dn832103.aspx)   
 [Xác định Trường tổng số](https://technet.microsoft.com/library/dn832103.aspx)
