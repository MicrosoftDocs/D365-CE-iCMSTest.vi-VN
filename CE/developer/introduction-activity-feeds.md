...
ms.locfileid: "386942"
---
# <a name="introduction-to-activity-feeds"></a>Introduction to activity feeds
...
## <a name="activity-feeds-concepts"></a>Activity feeds concepts  
...
|          Giống như           |                                                                                                                                                                                                                     An action taken by a user on a post that expresses that the user liked the post. **Ghi chú:**                                                                                                                                                                                                                     |
|         Unlike          |                                                                                                                                                                                                                               An action taken by a user to remove the Like from the post. **Ghi chú:**                                                                                                                                                                                                                                |
| Thread or Conversation  |                                                                                                                                                                                                                                          A collection of posts and all related comments.                                                                                                                                                                                                                                           |
|          Dạng xem           |                                                                                                                                                                                                                                             A view of entity records based on a query.                                                                                                                                                                                                                                             |
...
## <a name="activity-feeds-entities"></a>Activity feeds entities  
...
## <a name="likeunlike"></a>Like/Unlike  
...
## <a name="displaying-data-on-the-record-wall-or-personal-wall"></a>Displaying data on the record wall or personal wall  
...
### <a name="see-also"></a>Xem thêm  
 ...
 [Kết nối với Yammer](connect-yammer.md)   
