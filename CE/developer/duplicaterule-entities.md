...
ms.locfileid: "388287"
---
# <a name="duplicate-rule-entities"></a>Duplicate Rule entities
...
- [Quy tắc trùng lặp](entities/duplicaterule.md)
- [Điều kiện Quy tắc Trùng lặp](entities/duplicaterulecondition.md)
...
## <a name="duplicaterule"></a>Quy tắc trùng lặp
...
|[Mô tả](entities/duplicaterule.md#BKMK_Description)|Description of the duplicate detection rule.|
...
|[Tên](entities/duplicaterule.md#BKMK_Name)|Name of the duplicate detection rule.|
...
|[Mã trạng thái](entities/duplicaterule.md#BKMK_StatusCode)|Reason for the status of the duplicate detection rule.|

### <a name="inactive-states"></a>Inactive states
...
|[KbArticle.StateCode](entities/KbArticle.md#BKMK_StateCode)|`Draft`, `Unapproved`, `Published`|Không áp dụng|  
...
## <a name="duplicaterule-special-messages"></a>DuplicateRule Special messages
...
## <a name="duplicaterulecondition"></a>Điều kiện Quy tắc Trùng lặp
...
## <a name="duplicaterulecondition-special-messages"></a>DuplicateRuleCondition Special messages
