...
ms.locfileid: "387523"
---
# <a name="modify-the-icons-for-an-entity"></a>Modify the icons for an entity
...
## <a name="types-of-icons"></a>Types of icons  
 The following table liststhe types of entity icons you can update.  


|                                                             Loại                                                             |           Specifications           |                            Thuộc tính                             |
|------------------------------------------------------------------------------------------------------------------------------|------------------------------------|-----------------------------------------------------------------|
|            **Biểu tượng trong Ứng dụng web**<br /><br /> Displays when records for this entity are displayed in a grid.            | -   16x16px<br />-   Less than 10k | <xref:Microsoft.Xrm.Sdk.Metadata.EntityMetadata.IconSmallName>  |
