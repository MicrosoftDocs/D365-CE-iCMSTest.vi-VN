...
ms.locfileid: "386387"
---
# <a name="create-and-manage-custom-business-apps-in-customer-engagement-using-code"></a>Tạo và quản lý các ứng dụng doanh nghiệp tùy chỉnh trong Customer Engagement bằng cách dùng mã
...
## <a name="create-your-business-app-and-define-its-properties"></a>Create your business app and define its properties
...
## <a name="add-or-remove-components-from-your-business-app"></a>Add or remove components from your business app
...
## <a name="validate-your-business-app"></a>Validate your business app
...
## <a name="publish-your-business-app"></a>Publish your business app
...
## <a name="manage-access-to-business-app-using-security-roles"></a>Manage access to business app using security roles
...
To disassociate a security role from a business app, you use the DELETE request with the same navigation property. Ví dụ:
...
## <a name="manage-your-business-apps-and-its-components"></a>Manage your business apps and its components
...
### <a name="retrieve-published-apps"></a>Retrieve published apps
To retrieve published apps, use the following request:

`GET [Organization URI]/api/data/v9.0/appmodules?$select=name,clienttype`

### <a name="retrieve-unpublished-apps"></a>Retrieve unpublished apps
To retrieve unpublished apps, use the <xref:Microsoft.Dynamics.CRM.RetrieveUnpublishedMultiple> function. Ví dụ:

`GET [Organization URI]/api/data/v9.0/appmodules/Microsoft.Dynamics.CRM.RetrieveUnpublishedMultiple()?$select=name,clienttype`

### <a name="retrieve-components-in-a-published-business-app"></a>Retrieve components in a published business app
To retrieve app components for a business app, use the <xref:Microsoft.Dynamics.CRM.RetrieveAppComponents> function or the <xref:Microsoft.Crm.Sdk.Messages.RetrieveAppComponentsRequest> message. Ví dụ:

`GET [Organization URI]/api/data/v9.0/RetrieveAppComponents(AppModuleId=dd621d4a-d898-e711-80e7-00155db763be)`

### <a name="retrieve-security-roles-associated-with-published-business-app"></a>Retrieve security roles associated with published business app
...
### <a name="delete-business-apps"></a>Delete business apps

Use the DELETE request to delete a business app. Ví dụ:

`DELETE [Organization URI]/api/data/v9.0/appmodules(dd621d4a-d898-e711-80e7-00155db763be)`

## <a name="client-api-support-for-business-apps"></a>Client API support for business apps
...
[Thiết kế ứng dụng tùy chỉnh dành cho doanh nghiệp bằng trình thiết kế ứng dụng](../customize/design-custom-business-apps-using-app-designer.md)
