...
ms.locfileid: "388351"
---
# <a name="write-a-listener-application-for-a-azure-solution"></a>Write a listener application for a Azure solution
...
## <a name="write-a-queue-listener"></a>Write a queue listener
...
## <a name="write-a-one-way-two-way-or-rest-listener"></a>Write a one-way, two-way, or REST listener
...
### <a name="one-way-listener"></a>One-way listener
...
### <a name="two-way-listener"></a>Two-way listener
...
## <a name="filter-messages"></a>Filter messages
...
## <a name="read-the-data-context-in-multiple-data-formats"></a>Read the data context in multiple data formats
