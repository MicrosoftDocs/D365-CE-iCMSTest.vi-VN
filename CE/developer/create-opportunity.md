...
ms.locfileid: "388395"
---
# <a name="create-an-opportunity"></a>Create an opportunity
...
## <a name="prepare-data-for-an-opportunity"></a>Prepare Data for an Opportunity  
...
## <a name="add-existing-products-and-write-in-products"></a>Add Existing Products and Write-in Products  
...
### <a name="add-existing-products-from-the-product-catalog"></a>Add Existing Products from the Product Catalog  
...
### <a name="add-write-in-products"></a>Add Write-in Products  
...
## <a name="price-overriding"></a>Price Overriding  
...
## <a name="apply-discounts"></a>Apply Discounts  
...
## <a name="calculate-tax-and-totals"></a>Calculate Tax and Totals  
...
## <a name="close-an-opportunity"></a>Close an Opportunity  
