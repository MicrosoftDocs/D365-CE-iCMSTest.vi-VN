...
ms.locfileid: "387167"
---
# <a name="set-field-values-using-parameters-passed-to-a-form"></a>Set field values using parameters passed to a form
...
## <a name="pass-parameters-to-set-field-record-values"></a>Pass parameters to set field record values  
...
## <a name="example-set-the-value-for-string-fields"></a>Example: Set the value for string fields  
...
## <a name="set-values-for-lookup-fields"></a>Set values for lookup fields  
...
|customer lookup|Cho phép một tham chiếu duy nhất vào một tài khoản hoặc hồ sơ địa chỉ liên lạc.|  
|owner lookup|Allows for a single reference to either a team or a system user record.|  
|partylist lookup|Cho phép nhiều tham chiếu đến nhiều thực thể.|  
|regarding lookup|Cho phép một tham chiếu đến nhiều thực thể.|  
...
## <a name="example-set-the-value-for-lookup-fields"></a>Example: Set the value for lookup fields  
...
## <a name="example-set-the-value-for-date-fields"></a>Example: Set the value for date fields  
...
## <a name="example-set-the-value-for-option-set-fields"></a>Example: Set the value for option set fields  
...
## <a name="example-set-the-value-for-multi-select-option-set-fields"></a>Example: Set the value for multi-select option set fields
...
## <a name="example-use-xrmnavigationopenform-to-open-a-new-window"></a>Example: Use Xrm.Navigation.openForm to open a new window  
...
## <a name="example-use-windowopen-to-open-a-new-window"></a>Example: Use window.open to open a new window  
