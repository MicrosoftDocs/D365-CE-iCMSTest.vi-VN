...
ms.locfileid: "387902"
---
# <a name="sample-code-directory-for-dynamics-365-for-customer-engagement-apps"></a>Sample code directory for Dynamics 365 for Customer Engagement apps
...
## <a name="administration--security"></a>Administration & security  
...
## <a name="bulk-delete"></a>Bulk Delete  
...
## <a name="business-process-flows"></a>Dòng quy trình công việc  
...
## <a name="charts-and-dashboards"></a>Biểu đồ và bảng thông tin  
...
## <a name="dynamics-365-for-customer-engagement-for-outlook"></a>Dynamics 365 for Customer Engagement for Outlook  
...
## <a name="customization--metadata"></a>Customization & metadata
...
## <a name="entity-records"></a>Entity records  
...
## <a name="organization-web-service"></a>Organization web service  
...
## <a name="processes-workflows-and-dialogs"></a>Processes, workflows and dialogs  
...
## <a name="sales-leads-opportunities-quotes-orders-invoices-connections"></a>Sales: Leads, opportunities, quotes, orders, invoices, connections  
...
## <a name="sample-data"></a>Dữ liệu mẫu  
