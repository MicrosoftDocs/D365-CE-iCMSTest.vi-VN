...
ms.locfileid: "387702"
---
# <a name="webpage-html-web-resources"></a>Webpage (HTML) web resources
...
## <a name="capabilities-of-html-web-resources"></a>Capabilities of HTML web resources
...
## <a name="limitations-of-html-web-resources"></a>Limitations of HTML web resources  
...
## <a name="use-the-text-editor-for-html-web-resources"></a>Use the text editor for HTML web resources
...
## <a name="prevent-editing-of-web-resources-for-managed-solutions"></a>Prevent editing of web resources for managed solutions
...
## <a name="reference-other-web-resources-from-an-html-web-resource"></a>Reference other web resources from an HTML web resource
...
## <a name="pass-parameters-to-html-web-resources"></a>Pass parameters to HTML web resources
...
| Tham số  |            Tên            |                                                                                                               Mô tả                                                                                                               |
|------------|----------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|  typename  |        Tên Thực thể         |                                                                                                         The name of the entity.                                                                                                         |
|    loại    |      Entity Type Code      |                                                                               An integer that uniquely identifies the entity in a specific organization.                                                                                |
|     ID     |        Object GUID         |                                                                                                   The GUID that represents a record.                                                                                                    |
|  orgname   |     Tên tổ chức      |                                                                                                  The unique name of the organization.                                                                                                   |
...
|    dữ liệu    |  Optional Data Parameter   |                                                                                                  An optional value that may be passed.                                                                                                  |
...
|  bảo mật  |                            |                                                                                              [!INCLUDE[internal](../includes/internal.md)]                                                                                              |
