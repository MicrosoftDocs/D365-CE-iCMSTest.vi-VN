...
ms.locfileid: "386923"
---
# <a name="customize-labels-to-support-multiple-languages"></a>Customize labels to support multiple languages
...
## <a name="using-labels"></a>Using labels  

|Microsoft.Xrm.Sdk.dll|API Web|
|----------------|----------------|
|<xref:Microsoft.Xrm.Sdk.Label> lớp|<xref href="Microsoft.Dynamics.CRM.Label?text=Label ComplexType" />|
|<xref:Microsoft.Xrm.Sdk.LocalizedLabel> lớp|<xref href="Microsoft.Dynamics.CRM.LocalizedLabel?text=LocalizedLabel ComplexType" />|
...
## <a name="messages-to-use-with-labels"></a>Messages to use with labels  
...
## <a name="customize-labels-in-the-base-language"></a>Customize labels in the base language  
...
## <a name="translate-customized-entity-and-attribute-text"></a>Translate customized entity and attribute text  
...
### <a name="export-customized-text-for-translation"></a>Export customized text for translation  
...
### <a name="import-translated-text"></a>Import translated text  
...
> [!NOTE]
> [!INCLUDE[pn_dynamics_crm](../includes/pn-dynamics-crm.md)] apps cannot import translated text that is over 500 characters long. Nếu bất kỳ mục nào trong tệp đã dịch của bạn dài hơn 500 ký tự, tiến trình nhập sẽ thất bại. If the import process fails, review the line in the file that caused the failure, reduce the number of characters, and try to import again.  
...
## <a name="manage-languages-for-your-organization"></a>Manage languages for your organization  
