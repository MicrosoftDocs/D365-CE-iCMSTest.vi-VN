...
ms.locfileid: "387575"
---
# <a name="work-with-solutions"></a>Work with solutions
...
## <a name="create-a-publisher"></a>Create a publisher
...
## <a name="retrieve-the-default-publisher"></a>Retrieve the default publisher  
...
## <a name="create-a-solution"></a>Create a solution
...
## <a name="retrieve-a-solution"></a>Retrieve a solution  
...
## <a name="add-a-new-solution-component"></a>Add a new solution component  
...
## <a name="add-an-existing-solution-component"></a>Add an existing solution component  
...
## <a name="remove-a-solution-component"></a>Remove a solution component  
...
## <a name="export-or-package-a-solution"></a>Export or package a solution  
...
## <a name="install-or-upgrade-a-solution"></a>Install or upgrade a solution  
...
### <a name="tracking-import-success"></a>Tracking import success
...
#### <a name="retrieving-import-job-data"></a>Retrieving import job data
...
## <a name="detect-solution-dependencies"></a>Detect solution dependencies
...
### <a name="dependency-report"></a>Dependency report
...
### <a name="detect-whether-a-solution-component-may-be-delete"></a>Detect whether a solution component may be delete
