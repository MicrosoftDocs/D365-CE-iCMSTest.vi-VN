...
ms.locfileid: "386624"
---
# <a name="create-real-time-workflows"></a>Create real-time workflows
...
## <a name="required-security-privileges"></a>Required security privileges  
...
## <a name="create-a-real-time-workflow-in-code"></a>Create a real-time workflow in code  
...
## <a name="convert-an-asynchronous-workflow-to-real-time-and-back"></a>Convert an asynchronous workflow to real-time and back  
...
#### <a name="convert-an-asynchronous-workflow-to-real-time"></a>Convert an asynchronous workflow to real-time  
...
#### <a name="convert-a-real-time-workflow-to-asynchronous"></a>Convert a real-time workflow to asynchronous  
...
## <a name="error-handling-and-rollback"></a>Error handling and rollback  
...
## <a name="package-a-real-time-workflow-for-distribution"></a>Package a real-time workflow for distribution  
...
### <a name="see-also"></a>Xem thêm  
 ...
 [Tạo hành động của riêng bạn](create-own-actions.md)   
