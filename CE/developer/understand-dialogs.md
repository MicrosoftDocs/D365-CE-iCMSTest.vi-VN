...
ms.locfileid: "388447"
---
# <a name="understand-dialogs"></a>Understand dialogs
...
## <a name="dialog-components"></a>Thành phần hộp thoại  
...
### <a name="prompt-and-response"></a>Lời nhắc và phản hồi  
...
## <a name="input-argument-and-variable"></a>Input argument and variable  
...
### <a name="input-argument"></a>Input argument  
...
## <a name="dialog-limitations"></a>Dialog limitations  
