...
ms.locfileid: "388520"
---
# <a name="connection-entities"></a>Connection entities

[!INCLUDE[](../includes/cc_applies_to_update_9_0_0.md)]

The *connections* provide a flexible way to connect and describe the relationships between any two entity records [!INCLUDE[pn_microsoftcrm](../includes/pn-microsoftcrm.md)] apps. It helps you to promote teamwork, collaboration, and effective management of business and sales processes. Kết nối cho phép bạn dễ dàng liên kết người dùng, liên hệ, báo giá, đơn hàng và nhiều hồ sơ thực thể khác với nhau. The records in the association can be assigned particular roles that help define the purpose of the relationship.  
...
## <a name="enabling-and-creating-connections"></a>Enabling and creating connections  
...
## <a name="querying-connections"></a>Querying connections  
