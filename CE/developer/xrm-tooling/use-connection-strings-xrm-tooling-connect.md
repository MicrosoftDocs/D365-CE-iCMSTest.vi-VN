...
ms.locfileid: "386790"
---
# <a name="use-connection-strings-in-xrm-tooling-to-connect-to-dynamics-365-for-customer-engagement"></a>Use connection strings in XRM tooling to connect to Dynamics 365 for Customer Engagement
...
## <a name="create-a-connection-string"></a>Create a connection string
...
## <a name="connection-string-parameters"></a>Connection string parameters
...
|         `RedirectUri` hoặc `ReplyUrl`         |                                                                                                                                                                                                                                                Specifies the redirect URI of the application you registered in [!INCLUDE[pn_microsoft_azure_active_directory](../../includes/pn-microsoft-azure-active-directory.md)] or [!INCLUDE[pn_Active_Dir_Fed_Svcs_AD_FS](../../includes/pn-active-dir-fed-svcs-ad-fs.md)].<br /><br /> This parameter is applicable only when the authentication type is specified as `OAuth`.                                                                                                                                                                                                                                                |
...
|               `Thumbprint` hoặc `CertificateThumbprint`               |                                                                                                                                                Specifies the thumbprint of the certificate to be utilized during an S2S connection. When set, AppID is required and UserID and Password values are ignored.                                                                                                         |
|               `StoreName` hoặc `CertificateStoreName`               |                                                                                                                                                Specifies the store name where the certificate identified by thumbprint can be found. When set, Thumbprint is required.                                                                                                         |

<a name="Examples"></a>

## <a name="connection-string-examples"></a>Connection string examples
...
### <a name="integrated-on-premises-authentication"></a>Integrated on-premises authentication  

```xml
<add name="MyCRMServer" connectionString="AuthType=AD;Url=http://contoso:8080/Test;" />  
```  

### <a name="named-account-using-on-premises-authentication"></a>Named account using on-premises authentication  
...
### <a name="named-account-using-office-365"></a>Named account using Office 365  
...
### <a name="oauth-using-named-account-in-office-365-with-ux-to-prompt-for-authentication"></a>OAuth using named account in Office 365 with UX to prompt for authentication  
...
### <a name="oauth-using-named-account-in-includepndynamicscrmincludespn-dynamics-crmmd-on-premises-with-ux-to-prompt-for-authentication"></a>OAuth using named account in [!INCLUDE[pn_dynamics_crm](../../includes/pn-dynamics-crm.md)] on-premises with UX to prompt for authentication  
...
### <a name="ifd-using-a-named-account-with-delegation-to-a-sub-realm"></a>IFD using a named account with delegation to a sub realm  
...
## <a name="determine-your-connection-status"></a>Determine your connection status
