...
ms.locfileid: "386628"
---
# <a name="use-the-xrm-tooling-common-login-control-in-your-client-applications"></a>Use the XRM tooling common login control in your client applications
...
## <a name="create-a-wpf-application-using-the-common-login-control-template"></a>Create a WPF application using the common login control template
...
## <a name="add-the-common-login-control-template-to-your-existing-wpf-application"></a>Add the common login control template to your existing WPF application
