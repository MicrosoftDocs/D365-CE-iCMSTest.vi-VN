...
ms.locfileid: "388836"
---
# <a name="work-with-business-process-flows-using-code"></a>Work with business process flows using code
...
<a name="PrereqsBPF"></a>   
## <a name="prerequisites-for-business-process-flow"></a>Prerequisites for business process flow 
...
<a name="DefineBPF"></a>   
## <a name="define-business-process-flow"></a>Define business process flow
...
## <a name="activate-business-process-flow"></a>Activate business process flow  
...
<a name="BPFEntity"></a>   
## <a name="business-process-flow-entity"></a>Business process flow entity 
...
### <a name="create-a-business-process-flow-entity-record-process-instance"></a>Create a business process flow entity record (process instance) 
...
### <a name="update-a-business-process-flow-entity-record-process-instance"></a>Update a business process flow entity record (process instance)
...
#### <a name="stage-navigation"></a>Stage navigation
...
#### <a name="change-the-state-of-a-process-instance-abort-reactivate-or-finish"></a>Change the state of a process instance: Abort, Reactivate, or Finish 
...
#### <a name="cross-entity-navigation"></a>Cross-entity navigation
...
### <a name="delete-a-business-process-flow-entity-record-process-instance"></a>Delete a business process flow entity record (process instance)
...
## <a name="use-retrieveprocessinstances-and-retrieveactivepath-messages"></a>Use RetrieveProcessInstances and RetrieveActivePath messages
...
<a name="ApplyBPF"></a>   
## <a name="apply-business-process-flow-while-creating-an-entity-record"></a>Apply business process flow while creating an entity record
...
## <a name="legacy-process-related-attributes-in-entities"></a>Legacy process-related attributes in entities
...
## <a name="client-side-programmability-support-for-business-process-flows"></a>Client-side programmability support for business process flows  
...
## <a name="maximum-number-of-processes-stages-and-steps"></a>Số lượng tối đa quy trình, giai đoạn và các bước  
...
### <a name="see-also"></a>Xem thêm    
 ...
 [Dòng quy trình công việc](../customize/business-process-flows-overview.md)
