...
ms.locfileid: "388343"
---
# <a name="active-directory-and-claims-based-authentication"></a>Active Directory and claims-based authentication
...
## <a name="supported-authentication-scenarios"></a>Supported authentication scenarios 
...
|                                                 Triển khai                                                 |                                                  Authentication model                                                   |
|------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|
|                          Ứng dụng [!INCLUDE[pn_CRM_Online](../includes/pn-crm-online.md)]                           | Claims-based or [!INCLUDE[pn_Active_Directory](../includes/pn-active-directory.md)] (through federation) authentication |
...
### <a name="how-claims-based-authentication-works"></a>How claims-based authentication works  
...
### <a name="how-active-directory-authentication-works"></a>How Active Directory authentication works  
...
## <a name="unsupported-authentication-scenarios"></a>Unsupported authentication scenarios
...
## <a name="authentication-classes"></a>Authentication classes
...
|                                                     Các lớp                                                     |                                                                                                                                                                                                          Sử dụng                                                                                                                                                                                                           |                                                                                                                                                                   Related Documentation                                                                                                                                                                   |
|-----------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
## <a name="authentication-by-using-the-client-proxy-classes"></a>Authentication by using the client proxy classes  
...
## <a name="handling-channel-exceptions-and-faults"></a>Handling channel exceptions and faults  
...
<a name="bkmk_saml"></a>   
## <a name="additional-information-about-the-security-saml-token"></a>Additional information about the security (SAML) token  
 The SAML token used during user authentication is described below.  

### <a name="contents-of-the-saml-token"></a>Contents of the SAML token  
...
### <a name="lifecycle-of-the-security-token"></a>Lifecycle of the security token  
