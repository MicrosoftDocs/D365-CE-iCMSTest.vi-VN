...
ms.locfileid: "388690"
---
# <a name="walkthrough-configure-assembly-security-for-an-offline-plug-in"></a>Walkthrough: Configure assembly security for an offline plug-in
...
### <a name="get-the-public-key-token"></a>Get the public key token  
...
### <a name="add-an-allowlist-key"></a>Add an AllowList key  
