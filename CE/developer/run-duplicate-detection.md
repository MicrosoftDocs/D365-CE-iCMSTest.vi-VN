...
ms.locfileid: "386229"
---
# <a name="run-duplicate-detection"></a>Run duplicate detection
...
## <a name="retrieve-and-detect-duplicates-for-a-specified-record"></a>Retrieve and detect duplicates for a specified record
...
### <a name="example-detect-duplicates-for-a-specified-record-using-web-api"></a>Example: Detect duplicates for a specified record using Web API
...
## <a name="detect-duplicates-for-an-entity-type"></a>Detect duplicates for an entity type
...
### <a name="example-detect-duplicates-for-an-entity-type-using-the-web-api"></a>Example: Detect duplicates for an entity type using the Web API 
...
## <a name="detect-duplicates-during-create-and-update-operations"></a>Detect duplicates during Create and Update operations
...
###  <a name="example-duplicate-detection-using-the-organization-service"></a>Example: Duplicate detection using the Organization Service
