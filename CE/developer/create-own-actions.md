...
ms.locfileid: "385956"
---
# <a name="create-your-own-actions"></a>Create your own actions
...
## <a name="about-action-definitions"></a>About action definitions  
...
## <a name="required-permissions"></a>Các quyền bắt buộc  
...
## <a name="create-an-action-using-code"></a>Create an action using code  
...
### <a name="add-input-and-output-arguments"></a>Add input and output arguments  
...
|---------------|-------------------|  
|System.Int32|Số nguyên|  
|System.String|Chuỗi|  
|<xref:Microsoft.Xrm.Sdk.EntityReference>|EntityReference|  
|<xref:Microsoft.Xrm.Sdk.Entity>|Thực thể|  
|<xref:Microsoft.Xrm.Sdk.EntityCollection>|EntityCollection|  
|System.DateTime|Ngày Giờ|  
|System.Double|Nổi|  
|System.Decimal|Thập phân|  
|<xref:Microsoft.Xrm.Sdk.Money>|Loại tiền|  
|System.Boolean|Boolean|  
|<xref:Microsoft.Xrm.Sdk.OptionSetValue>|Danh sách chọn|  
  
 Supported argument attributes are listed in the following table.  
  
|Argument Attribute|Mô tả|  
|------------------------|-----------------|  
...
## <a name="package-an-action-for-distribution"></a>Package an action for distribution  
...
## <a name="generate-early-bound-types-for-an-action"></a>Generate early-bound types for an action  
...
## <a name="execute-an-action-using-the-web-api"></a>Execute an action using the Web API  
...
## <a name="execute-an-action-using-the-organization-service"></a>Execute an action using the organization service  
...
### <a name="execute-an-action-using-a-javascript-web-resource"></a>Execute an action using a JavaScript web resource  
...
## <a name="execute-an-action-using-a-process"></a>Execute an action using a process  
...
## <a name="watch-out-for-long-running-actions"></a>Watch out for long running actions  
...
### <a name="see-also"></a>Xem thêm  
 ...
 [Tùy chỉnh hệ thống của bạn](https://technet.microsoft.com/library/dn531158.aspx)
