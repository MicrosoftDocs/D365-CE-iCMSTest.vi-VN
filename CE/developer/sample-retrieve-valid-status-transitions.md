...
ms.locfileid: "385855"
---
# <a name="sample-retrieve-valid-status-transitions"></a>Sample: Retrieve valid status transitions
...
3. Displays the valid transition options in the console  
   ...
   ![Ví dụ về chuyển đổi lý do dẫn đến trạng thái với trường hợp](media/status-reason-transitions-example.PNG "Ví dụ về chuyển đổi lý do dẫn đến trạng thái với trường hợp")  
...
### <a name="see-also"></a>Xem thêm  
 [Xác định chuyển tiếp mô hình trạng thái tùy chỉnh](define-custom-state-model-transitions.md)
