...
ms.locfileid: "385724"
---
# <a name="create-goal-hierarchy-goals-and-targets"></a>Create goal hierarchy, goals, and targets
...
## <a name="create-goal-hierarchy"></a>Create Goal Hierarchy  
...
## <a name="who-manages-and-owns-a-goal"></a>Who Manages and Owns a Goal  
...
## <a name="set-and-monitor-the-targets"></a>Set and Monitor the Targets  
...
|Goal entity attribute|Mô tả|Công thức|  
|---------------------------|-----------------|-------------|  
...
## <a name="specify-the-time-period"></a>Specify the Time Period  
...
<a name="BKMK_other"></a>   
## <a name="other-important-settings"></a>Other Important Settings  
