...
ms.locfileid: "386355"
---
# <a name="campaign-entities"></a>Campaign entities
...
## <a name="campaigns-and-quick-campaigns"></a>Campaigns and Quick Campaigns  
...
|Tính năng|Chiến dịch|Chiến dịch Nhanh gọn|  
|-------------|--------------|--------------------|  
