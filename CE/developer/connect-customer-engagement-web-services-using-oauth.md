...
ms.locfileid: "387758"
---
# <a name="connect-to-dynamics-365-for-customer-engagement-web-services-using-oauth"></a>Connect to Dynamics 365 for Customer Engagement web services using OAuth
...
## <a name="authenticate-using-adal"></a>Authenticate using ADAL  
...
## <a name="use-the-access-token-in-message-requests"></a>Use the access token in message requests  
...
### <a name="http-message-request"></a>HTTP message request  
...
### <a name="web-client-requests"></a>Web client requests
...
## <a name="discover-the-authority-at-run-time"></a>Discover the authority at run time
