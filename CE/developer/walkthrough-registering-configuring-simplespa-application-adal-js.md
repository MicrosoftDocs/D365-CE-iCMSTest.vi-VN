...
ms.locfileid: "386154"
---
# <a name="walkthrough-registering-and-configuring-simplespa-application-with-adaljs"></a>Walkthrough: Registering and configuring SimpleSPA application with adal.js
...
### <a name="create-a-web-application-project"></a>Create a web application project  
...
### <a name="debugging-the-application"></a>Debugging the application  
