...
ms.locfileid: "386599"
---
# <a name="process-categories"></a>Process categories
...
## <a name="xaml-declarative-workflows"></a>XAML (Declarative) workflows
...
## <a name="differences-between-workflows-and-dialogs"></a>Differences between workflows and dialogs
...
## <a name="when-to-use-a-workflow-instead-of-a-plug-in"></a>When to use a workflow instead of a plug-in
...
## <a name="distributing-workflows-in-solutions"></a>Distributing workflows in solutions
