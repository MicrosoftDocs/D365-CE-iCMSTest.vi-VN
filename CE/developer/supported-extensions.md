...
## <a name="customizations-using-includepndynamicscrmincludespn-dynamics-crmmd-web-application"></a>Customizations using [!INCLUDE[pn_dynamics_crm](../includes/pn-dynamics-crm.md)] web application  
...
## <a name="customizations-using-the-includepndynamicscrmincludespn-dynamics-crmmd-sdk"></a>Customizations using the [!INCLUDE[pn_dynamics_crm](../includes/pn-dynamics-crm.md)] SDK 
...
### <a name="includepndynamicscrmincludespn-dynamics-crmmd-web-services"></a>[!INCLUDE[pn_dynamics_crm](../includes/pn-dynamics-crm.md)] web services
...
### <a name="client-side-javascript"></a>Client-side JavaScript 
...
### <a name="solution-file"></a>Solution file  
...
## <a name="support-for-net-framework-versions"></a>Support for .NET Framework Versions  
...
## <a name="unsupported-customizations"></a>Unsupported customizations
