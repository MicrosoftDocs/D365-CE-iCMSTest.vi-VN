...
ms.locfileid: "387898"
---
# <a name="web-api-conditional-operations-sample"></a>Web API Conditional Operations Sample
...
|Loại thực thể|Client-assigned properties|Server-assigned properties|  
|-----------------|---------------------------------|---------------------------------|  
...
## <a name="conditional-get"></a>Conditional GET
...
## <a name="optimistic-concurrency-on-delete-and-update"></a>Optimistic concurrency on delete and update
...
## <a name="controlling-upsert-operations"></a>Controlling upsert operations
