...
ms.locfileid: "385914"
---
# <a name="web-api-basic-operations-sample"></a>Web API Basic Operations Sample
...
## <a name="section-1-basic-create-and-update-operations"></a>Section 1: Basic create and update operations 
...
## <a name="section-2-create-with-association"></a>Section 2: Create with association 
...
## <a name="section-3-create-related-entities-deep-insert"></a>Section 3: Create related entities (deep insert)  
...
## <a name="section-4-associate-and-disassociate-existing-entities"></a>Section 4: Associate and disassociate existing entities  
...
## <a name="section-5-delete-entities-sample-cleanup"></a>Section 5: Delete entities (sample cleanup) 
