...
ms.locfileid: "386222"
---
# <a name="web-api-samples-c"></a>Web API Samples (C#)
...
## <a name="web-api-samples-listing-c"></a>Web API samples listing (C#)  
...
## <a name="how-to-download-and-run-the-samples"></a>How to download and run the samples  
...
## <a name="common-elements-found-in-each-sample"></a>Common elements found in each sample  
...
### <a name="utilized-libraries-and-frameworks"></a>Utilized libraries and frameworks  
...
### <a name="response-success-and-error-handling"></a>Response success and error handling  
...
### <a name="characteristics-and-methods"></a>Characteristics and methods  
...
#### <a name="connecttocrm-method"></a>ConnectToCRM method  
...
#### <a name="createrequiredrecords-method"></a>CreateRequiredRecords method  
...
#### <a name="runasync-method"></a>RunAsync method  
...
#### <a name="displayexception-method"></a>DisplayException method  
...
#### <a name="deleterequiredrecords-method"></a>DeleteRequiredRecords method  
