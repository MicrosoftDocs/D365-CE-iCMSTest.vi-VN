...
ms.locfileid: "385728"
---
# <a name="use-web-api-functions"></a>Use Web API functions
...
## <a name="passing-parameters-to-a-function"></a>Passing parameters to a function  
...
## <a name="pass-reference-to-an-entity-to-a-function"></a>Pass reference to an entity to a function
...
## <a name="bound-and-unbound-functions"></a>Bound and unbound functions
...
### <a name="bound-functions"></a>Bound functions
...
### <a name="unbound-functions"></a>Unbound functions
...
## <a name="compose-a-query-with-functions"></a>Compose a query with functions
...
### <a name="composable-functions"></a>Composable functions
...
### <a name="query-functions"></a>Query functions
