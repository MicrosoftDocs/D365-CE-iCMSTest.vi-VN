...
ms.locfileid: "388268"
---
# <a name="retrieve-and-execute-predefined-queries"></a>Retrieve and execute predefined queries
...
### <a name="apply-a-query-to-any-collection-of-the-appropriate-type"></a>Apply a query to any collection of the appropriate type
...
## <a name="use-custom-fetchxml"></a>Use custom FetchXML
...
### <a name="paging-with-fetchxml"></a>Paging with FetchXML
...
### <a name="use-fetchxml-within-a-batch-request"></a>Use FetchXML within a Batch request
