...
ms.locfileid: "386146"
---
# <a name="web-api-samples-client-side-javascript"></a>Web API Samples (Client-side JavaScript)

[!INCLUDE[](../../includes/cc_applies_to_update_9_0_0.md)]

> [!NOTE]
> ![Trang này đang được xây dựng. Hãy kiểm tra lại sớm!](../../media/under_construction.png "Sắp ra mắt") [!INCLUDE[cc-under-construction](../../includes/cc-under-construction.md)]
