...
ms.locfileid: "388188"
---
# <a name="execute-batch-operations-using-the-web-api"></a>Execute batch operations using the Web API
...
## <a name="when-to-use-batch-requests"></a>When to use batch requests  
...
## <a name="batch-requests"></a>Batch requests  
...
## <a name="change-sets"></a>Change sets
