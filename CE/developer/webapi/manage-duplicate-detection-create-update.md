...
ms.locfileid: "385770"
---
# <a name="manage-duplicate-detection-for-create-and-update-operations-using-the-web-api"></a>Manage duplicate detection for create and update operations using the Web API
...
## <a name="detect-duplicate-during-create-operation"></a>Detect duplicate during Create operation
...
> [!NOTE]
>  Make sure there are appropriate duplicate detection rules in place. Dynamics 365 for Customer Engagement apps includes default duplicate detection rules for accounts, contacts, and leads, but not for other types of records. Nếu bạn muốn hệ thống phát hiện bản ghi trùng lặp cho các loại bản ghi khác, bạn cần phải tạo quy tắc mới. For information on how to create a duplicate detection rule, see [Duplicate detection rules](../../admin/set-up-duplicate-detection-rules-keep-data-clean.md).

<a name="bkmk_create"></a>
###  <a name="example-detect-duplicates-during-create-operation-using-the-web-api"></a>Example: Detect duplicates during Create operation using the Web API
...
## <a name="detect-duplicates-during-update-operation"></a>Detect duplicates during Update operation
