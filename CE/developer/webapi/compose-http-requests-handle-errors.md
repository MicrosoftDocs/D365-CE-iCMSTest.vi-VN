...
ms.locfileid: "388108"
---
# <a name="compose-http-requests-and-handle-errors"></a>Compose HTTP requests and handle errors
...
## <a name="web-api-url-and-versions"></a>Web API URL and versions

To access the Web API you must compose a URL using the parts in the following table.

|Phần|Mô tả|
|--|--|
|Giao thức|The appropriate protocol, either `https://` or `http://`.|
...
|Phiên bản|   The version is expressed this way: `v[Major_version].[Minor_version][PatchVersion]/`. The valid version for this release is <code class="x-hidden-focus">v9.0</code>.|
|Nguồn lực|The name of the entity, function, or action you want to use.|
...
|XÓA|Use when deleting entities or individual properties of entities.|  
...
## <a name="identify-status-codes"></a>Identify status codes
...
## <a name="parse-errors-from-the-response"></a>Parse errors from the response
