...
ms.locfileid: "388068"
---
# <a name="web-api-helper-code-configuration-classes"></a>Web API Helper code: Configuration classes
...
## <a name="connection-data"></a>Connection data

 The `Configuration`class reads and parses the application configuration file to obtain the following connection data.  


| Connection data |     Các triển khai     |                                                                                                                                  Mô tả                                                                                                                                  |
|-----------------|---------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|   Service URL   |         Tất cả         |                                                                                                                   The base URL to the Dynamics 365 for Customer Engagement service                                                                                                                    |
|    Tên người dùng     |         Tất cả         |                                                                                                                   The user name registered in Dynamics 365 for Customer Engagement apps                                                                                                                    |
|    Mật khẩu     |         Tất cả         |                                                                                                                          The password for that user                                                                                                                           |
|     Domain      |         Tất cả         |                                                                                                  The domain of the Dynamics 365 for Customer Engagement apps service for Active Directory authentication                                                                                                   |
...
|  URL Chuyển hướng   | Online and IFD only |                                                                                                                  A callback URI for the current application.                                                                                                                  |
...
### <a name="fileconfiguration-connection-settings"></a>FileConfiguration connection settings
...
## <a name="class-hierarchy-and-members"></a>Class hierarchy and members
...
### <a name="configuration-search-order"></a>Configuration search order
...
## <a name="default-configuration-file-listing"></a>Default configuration file listing
...
## <a name="class-listing"></a>Class listing
