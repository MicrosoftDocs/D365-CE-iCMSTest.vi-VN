...
ms.locfileid: "385940"
---
# <a name="setup-a-postman-environment"></a>Setup a Postman environment
...
## <a name="connect-with-an-online-environment"></a>Connect with an Online environment
...
### <a name="generate-an-access-token-to-use-with-your-environment"></a>Generate an Access Token to use with your environment
...
## <a name="connect-with-an-on-premise-environment"></a>Connect with an On-premise environment
...
### <a name="set-credentials"></a>Set Credentials
...
## <a name="test-your-connection"></a>Test your connection
