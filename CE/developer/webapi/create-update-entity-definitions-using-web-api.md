...
ms.locfileid: "387497"
---
# <a name="create-and-update-entity-definitions-using-the-web-api"></a>Create and update entity definitions using the Web API
...
## <a name="create-entities"></a>Tạo các thực thể  
...
|Mô tả|An entity to store information about customer bank accounts.|  
...
|HasNotes|false|  
 ...
 In addition to the properties listed previously, the `EntityMetadataAttributes` property must contain an array that includes one <xref href="Microsoft.Dynamics.CRM.StringAttributeMetadata?text=StringAttributeMetadata EntityType" /> to represent the primary name attribute for the entity. The attribute IsPrimaryName property must be true. The following table describes the properties set in the example.  
...
|Mô tả|Type the name of the bank account.|  
|IsPrimaryName|true|  
...
>  If you don’t include a `MSCRM.MergeLabels` header, the default behavior is as if the value were `false` and any localized labels not included in your update will be lost.  
 ...
 When you update an entity or attribute, you must use the <xref href="Microsoft.Dynamics.CRM.PublishXml?text=PublishXml Action" /> or <xref href="Microsoft.Dynamics.CRM.PublishAllXml?text=PublishAllXml Action" /> before the changes you make will be applied to the application. [!INCLUDE[proc_more_information](../../includes/proc-more-information.md)] [Publish Customizations](../customize-dev/publish-customizations.md)  
...
## <a name="create-attributes"></a>Create attributes
...
### <a name="create-a-string-attribute"></a>Create a string attribute

 The following example will use these properties to create a string attribute.  
  
|String attribute properties|Giá trị|  
|---------------------------------|------------|  
|SchemaName|new_BankName|  
|DisplayName|Bank Name|  
|Mô tả|Type the name of the bank.|  
|RequiredLevel|Không có|  
|MaxLength|100|  
|FormatName|Text|  
  
 The following example creates a string attribute using the properties and adds it to the entity with the MetadataId value of 402fa40f-287c-e511-80d2-00155d2a68d2. The URI for the attribute is returned in the response.  
...
### <a name="create-a-money-attribute"></a>Create a Money attribute

 The following example will use these properties to create a money attribute.  
  
|Money attribute properties|Giá trị|  
|--------------------------------|------------|  
|SchemaName|new_Balance|  
|DisplayName|Balance|  
|Mô tả|Enter the balance amount.|  
|RequiredLevel|Không có|  
...
### <a name="create-a-datetime-attribute"></a>Create a datetime attribute

 The following example will use these properties to create a datetime attribute.  
  
|Datetime attribute properties|Giá trị|  
|-----------------------------------|------------|  
|SchemaName|new_Checkeddate|  
|DisplayName|Date|  
|Mô tả|The date the account balance was last confirmed.|  
|RequiredLevel|Không có|  
|Định dạng|DateOnly **Note:**  For the valid options for this property, see <xref href="Microsoft.Dynamics.CRM.DateTimeFormat?text=DateTimeFormat EnumType" />.|  
  
 The following example creates a datetime attribute using the properties and adds it to the entity with the MetadataId value of 402fa40f-287c-e511-80d2-00155d2a68d2. The URI for the attribute is returned in the response.  
...
### <a name="create-a-customer-lookup-attribute"></a>Create a customer lookup attribute

 Unlike  other attributes, a customer lookup attribute is created using the <xref href="Microsoft.Dynamics.CRM.CreateCustomerRelationships?text=CreateCustomerRelationships Action" />. The parameters for this action require the definition of the lookup attribute and a pair of one-to-many relationships.  
...
|Customer lookup attribute properties|Giá trị|  
|------------------------------------------|------------|  
|SchemaName|new_CustomerId|  
|DisplayName|Khách hàng|  
|Mô tả|Sample Customer Lookup Attribute|  
...
## <a name="update-an-attribute"></a>Update an attribute
