...
ms.locfileid: "386608"
---
# <a name="web-api-types-and-operations"></a>Web API types and operations
...
|*Thực thể*|Instances of entity types (e.g. account, opportunity).|  
...
|*Hành động*|Operations that allow side effects, such as data modification, and cannot be further composed in order to avoid non-deterministic behavior|  
...
### <a name="service-document"></a>Service document  
...
<a name="bkmk_csdl"></a>   
### <a name="csdl-metadata-document"></a>CSDL $metadata document  
...
### <a name="metadata-annotations"></a>Metadata annotations  
...
|                    Thông tin                     |                                                                                                                                                                                                                                                         Mô tả                                                                                                                                                                                                                                                         |
|----------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                  **Mô tả**                   |                                                                                                        A description of the entity.<br /><br /> The <xref href="Microsoft.Dynamics.CRM.EntityMetadata?text=EntityMetadata EntityType" /> `Description` property information is included in the `EntityType` element using the `Annotation` element with the `Term` attribute value of Org.OData.Core.V1.Description.                                                                                                        |
...
|                  **Tên Hiển thị**                  |                                                                                                                                                                      This information is not in the `$metadata`, it’s retrieved from the <xref href="Microsoft.Dynamics.CRM.EntityMetadata?text=EntityMetadata EntityType" /> `DisplayName` property.                                                                                                                                                                       |
|                  **Khóa chính**                   | The property value that contains the unique identifier to refer to an instance of an entity.<br /><br /> The <xref href="Microsoft.Dynamics.CRM.EntityMetadata?text=EntityMetadata EntityType" /> `PrimaryIdAttribute` property value is included in the `EntityType` `Key` element. Each entity can have just one primary key.<br /><br /> Alternate keys are not listed here. [!INCLUDE[proc_more_information](../../includes/proc-more-information.md)] [Alternate keys](web-api-types-operations.md#bkmk_alternateKeys) |
...
|                   **Thuộc tính**                   |                                                                                                                                                                                                                               See [Properties](web-api-types-operations.md#bkmk_properties).                                                                                                                                                                                                                                |
...
### <a name="change-the-name-of-an-entity-set"></a>Change the name of an entity set  
...
### <a name="alternate-keys"></a>Alternate keys
...
### <a name="type-inheritance"></a>Type inheritance  
...
|Organization Service Type|Web API Type|Mô tả|  
|-------------------------------|------------------|-----------------|  
...
|Khách hàng|Single-valued navigation properties|The customer of an entity with this type of property may be a single-valued navigation property set to either an account or contact entity type using the respective single-valued navigation properties. When either of the respective single-valued collection properties is set, the other is cleared.|  
|Ngày Giờ|Edm.DateTimeOffset|Date and time with a time-zone offset, no leap seconds <br />There is no DateTime type in OData.|  
|Thập phân|Edm.Decimal|Numeric values with fixed precision and scale|  
|Gấp đôi|Edm.Double|IEEE 754 binary64 floating-point number (15-17 decimal digits)|  
|EntityName|Edm.String|Sequence of UTF-8 characters|  
|Hình ảnh|Edm.Binary|Binary data|  
|Số nguyên|Edm.Int32|Signed 32-bit integer|  
|Tra cứu|Single-valued navigation property|A reference to a specific entity|  
|ManagedProperty|Không áp dụng|For internal use only.|  
|Memo|Edm.String|Sequence of UTF-8 characters|  
|Loại tiền|Edm.Decimal|Numeric values with fixed precision and scale|  
|Chủ sở hữu|Single-valued navigation property|A reference to the <xref href="Microsoft.Dynamics.CRM.principal?text=principal EntityType" />. Both systemuser and team entity types inherit their ownerid property from the prinicipal entity type.|  
|Danh sách các bên|Collection-valued navigation property to the `activityparty` entity type.|The activitypartyparticipationtypemask property contains a value to represent the role of the participant. See [Activity Party Types](../activityparty-entity.md#ActivityPartyTypes) for more information.|  
|Danh sách chọn|Edm.Int32|Signed 32-bit integer|  
|Tiểu bang|Edm.Int32|Signed 32-bit integer|  
|Trạng thái|Edm.Int32|Signed 32-bit integer|  
|Chuỗi|Edm.String|Sequence of UTF-8 characters|  
|Uniqueidentifier|Edm.Guid|16-byte (128-bit) unique identifier|  

<a name="bkmk_lookupProperties"></a>   
### <a name="lookup-properties"></a>Lookup properties  
...
## <a name="navigation-properties"></a>Navigation properties  
...
### <a name="single-valued-navigation-properties"></a>Single-valued navigation properties  
...
### <a name="collection-valued-navigation-properties"></a>Collection-valued navigation properties  
...
## <a name="enumeration-types"></a>Enumeration types  
