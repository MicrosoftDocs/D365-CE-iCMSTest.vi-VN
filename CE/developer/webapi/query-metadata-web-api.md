...
ms.locfileid: "386674"
---
# <a name="query-metadata-using-the-web-api"></a>Query metadata using the Web API
...
## <a name="querying-the-entitymetadata-entity-type"></a>Querying the EntityMetadata entity type
...
## <a name="use-enum-types-in-filter-operations"></a>Use enum types in $filter operations
...
## <a name="use-complex-types-in-filter-operations"></a>Use complex types in $filter operations
...
## <a name="querying-entitymetadata-attributes"></a>Querying EntityMetadata attributes
...
### <a name="filtering-by-required-level"></a>Filtering by required level
...
## <a name="retrieving-attributes"></a>Retrieving attributes
...
## <a name="querying-relationship-metadata"></a>Querying relationship metadata
...
## <a name="querying-global-optionsets"></a>Querying Global OptionSets
