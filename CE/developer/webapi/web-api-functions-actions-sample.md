...
ms.locfileid: "386091"
---
# <a name="web-api-functions-and-actions-sample"></a>Web API Functions and Actions Sample
...
## <a name="sample-operations"></a>Sample operations  
...
## <a name="working-with-functions"></a>Working with functions  
...
### <a name="using-unbound-function-with-no-parameters"></a>Using unbound function with no parameters 
...
### <a name="using-unbound-function-with-parameters"></a>Using unbound function with parameters  
...
### <a name="using-bound-function-with-no-parameters"></a>Using bound function with no parameters  
...
## <a name="working-with-actions"></a>Working with actions  
...
### <a name="using-unbound-action-with-parameters"></a>Using unbound action with parameters 
...
### <a name="using-bound-action-with-parameters"></a>Using bound action with parameters
...
## <a name="working-with-custom-actions"></a>Working with custom actions  
...
### <a name="using-bound-custom-action-with-parameters"></a>Using bound custom action with parameters 
...
### <a name="using-unbound-custom-action-with-parameters"></a>Using unbound custom action with parameters  
...
### <a name="handling-custom-action-exceptions"></a>Handling custom action exceptions  
