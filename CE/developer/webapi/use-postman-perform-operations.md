...
ms.locfileid: "388674"
---
# <a name="use-postman-to-perform-operations-with-web-api"></a>Use Postman to perform operations with Web API
...
## <a name="retrieve-multiple-records"></a>Retrieve multiple records
...
## <a name="retrieve-a-particular-record"></a>Retrieve a particular record
...
## <a name="create-a-record"></a>Tạo bản ghi
...
## <a name="use-a-function"></a>Use a function
