...
ms.locfileid: "386808"
---
# <a name="retrieve-an-entity-using-the-web-api"></a>Retrieve an entity using the Web API
...
## <a name="basic-retrieve-example"></a>Basic Retrieve example
...
## <a name="retrieve-specific-properties"></a>Retrieve specific properties
...
## <a name="retrieve-using-an-alternate-key"></a>Retrieve using an alternate key
...
## <a name="retrieve-a-single-property-value"></a>Retrieve a single property value
...
## <a name="retrieve-navigation-property-values"></a>Retrieve navigation property values
...
## <a name="retrieve-related-entities-for-an-entity-by-expanding-navigation-properties"></a>Retrieve related entities for an entity by expanding navigation properties
...
## <a name="options-to-apply-to-expanded-entities"></a>Options to apply to expanded entities
...
## <a name="detect-if-an-entity-has-changed-since-it-was-retrieved"></a>Detect if an entity has changed since it was retrieved
...
## <a name="retrieve-formatted-values"></a>Retrieve formatted values
