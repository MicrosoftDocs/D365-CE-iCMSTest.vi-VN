...
ms.locfileid: "386546"
---
# <a name="web-api-query-data-sample"></a>Web API Query Data Sample
...
## <a name="selecting-specific-properties"></a>Selecting specific properties  
...
## <a name="using-query-functions"></a>Using query functions  
...
### <a name="includepndynamicscrmincludespn-dynamics-crmmd-query-functions"></a>[!INCLUDE[pn_dynamics_crm](../../includes/pn-dynamics-crm.md)] query functions  
...
## <a name="using-operators"></a>Using operators  
...
## <a name="setting-precedence"></a>Setting precedence  
...
## <a name="parameter-alias"></a>Parameter alias  
...
### <a name="top-results"></a>Top results  
...
### <a name="result-count"></a>Result count  
...
## <a name="expanding-results"></a>Expanding results  
...
### <a name="expand-on-single-valued-navigation-property"></a>Expand on single-valued navigation property  
...
### <a name="expand-on-partner-property"></a>Expand on partner property  
...
### <a name="expand-on-collection-valued-navigation-property"></a>Expand on collection-valued navigation property  
...
### <a name="expand-on-multiple-navigation-properties"></a>Expand on multiple navigation properties  
...
## <a name="fetchxml-queries"></a>FetchXML queries  
...
### <a name="fetchxml-pagination"></a>FetchXML pagination  
...
## <a name="predefined-queries"></a>Predefined queries  
...
### <a name="saved-query"></a>Saved query  
...
### <a name="user-query"></a>User query  
