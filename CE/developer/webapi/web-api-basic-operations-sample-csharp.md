...
search.app:
- D365CE
ms.openlocfilehash: 59dfa14f76ef7dcd9bd3676e53486e2333406230
...
ms.locfileid: "388478"
---
# <a name="web-api-basic-operations-sample-c"></a><span data-ttu-id="2f92b-103">Web API Basic Operations Sample (C#)</span><span class="sxs-lookup"><span data-stu-id="2f92b-103">Web API Basic Operations Sample (C#)</span></span>

[!INCLUDE[](../../includes/cc_applies_to_update_9_0_0.md)]

<span data-ttu-id="2f92b-104">This sample demonstrates how to perform basic CRUD (Create, Retrieve, Update, and Delete) and association and dissociation operations on Dynamics 365 for Customer Engagement apps entity instances, using the [!INCLUDE[pn_dynamics_crm](../../includes/pn-dynamics-crm.md)] apps Web API.</span><span class="sxs-lookup"><span data-stu-id="2f92b-104">This sample demonstrates how to perform basic CRUD (Create, Retrieve, Update, and Delete) and association and dissociation operations on Dynamics 365 for Customer Engagement apps entity instances, using the [!INCLUDE[pn_dynamics_crm](../../includes/pn-dynamics-crm.md)] apps Web API.</span></span>  

> [!NOTE]
>  <span data-ttu-id="2f92b-105">This sample implements the Dynamics 365 for Customer Engagement operations and console output detailed in [Web API Basic Operations Sample](web-api-basic-operations-sample.md) and uses the common C# constructs described in [Web API Samples (C#)](web-api-samples-csharp.md).</span><span class="sxs-lookup"><span data-stu-id="2f92b-105">This sample implements the Dynamics 365 for Customer Engagement operations and console output detailed in [Web API Basic Operations Sample](web-api-basic-operations-sample.md) and uses the common C# constructs described in [Web API Samples (C#)](web-api-samples-csharp.md).</span></span>  

<a name="bkmk_prerequisites"></a>   
## <a name="prerequisites"></a><span data-ttu-id="2f92b-106">Điều kiện tiên quyết</span><span class="sxs-lookup"><span data-stu-id="2f92b-106">Prerequisites</span></span>  
 <span data-ttu-id="2f92b-107">Prerequisites for all Dynamics 365 for Customer Engagement Web API C# samples are detailed in the [Prerequisites](web-api-samples-csharp.md#bkmk_prerequisites) section of the parent topic [Web API Samples (C#)](web-api-samples-csharp.md).</span><span class="sxs-lookup"><span data-stu-id="2f92b-107">Prerequisites for all Dynamics 365 for Customer Engagement Web API C# samples are detailed in the [Prerequisites](web-api-samples-csharp.md#bkmk_prerequisites) section of the parent topic [Web API Samples (C#)](web-api-samples-csharp.md).</span></span>  

<a name="bkmk_runSample"></a>   
## <a name="run-this-sample"></a><span data-ttu-id="2f92b-108">Run this sample</span><span class="sxs-lookup"><span data-stu-id="2f92b-108">Run this sample</span></span>  
 <span data-ttu-id="2f92b-109">First go to [Microsoft CRM Web API Basic Operations Sample (C#)](http://go.microsoft.com/fwlink/p/?LinkId=824042), download the sample archive file, Microsoft CRM Web API Basic Operations Sample (CS).zip, and extract its contents into a local folder.</span><span class="sxs-lookup"><span data-stu-id="2f92b-109">First go to [Microsoft CRM Web API Basic Operations Sample (C#)](http://go.microsoft.com/fwlink/p/?LinkId=824042), download the sample archive file, Microsoft CRM Web API Basic Operations Sample (CS).zip, and extract its contents into a local folder.</span></span> <span data-ttu-id="2f92b-110">This folder should contain the following files:</span><span class="sxs-lookup"><span data-stu-id="2f92b-110">This folder should contain the following files:</span></span>  


|                                             <span data-ttu-id="2f92b-111">File</span><span class="sxs-lookup"><span data-stu-id="2f92b-111">File</span></span>                                             |                                                                                                    <span data-ttu-id="2f92b-112">Purpose/Description</span><span class="sxs-lookup"><span data-stu-id="2f92b-112">Purpose/Description</span></span>                                                                                                    |
|----------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                                          <span data-ttu-id="2f92b-113">Program.cs</span><span class="sxs-lookup"><span data-stu-id="2f92b-113">Program.cs</span></span>                                          |                                                                                     <span data-ttu-id="2f92b-114">Contains the primary source code for this sample.</span><span class="sxs-lookup"><span data-stu-id="2f92b-114">Contains the primary source code for this sample.</span></span>                                                                                     |
|                                          <span data-ttu-id="2f92b-115">App.config</span><span class="sxs-lookup"><span data-stu-id="2f92b-115">App.config</span></span>                                          |                                                        <span data-ttu-id="2f92b-116">The application configuration file, which contains placeholder Dynamics 365 for Customer Engagement server connection information.</span><span class="sxs-lookup"><span data-stu-id="2f92b-116">The application configuration file, which contains placeholder Dynamics 365 for Customer Engagement server connection information.</span></span>                                                         |
|                  <span data-ttu-id="2f92b-117">Authentication.cs</span><span class="sxs-lookup"><span data-stu-id="2f92b-117">Authentication.cs</span></span><br /><span data-ttu-id="2f92b-118">Configuration.cs</span><span class="sxs-lookup"><span data-stu-id="2f92b-118">Configuration.cs</span></span><br /><span data-ttu-id="2f92b-119">Exceptions.cs</span><span class="sxs-lookup"><span data-stu-id="2f92b-119">Exceptions.cs</span></span>                  | <span data-ttu-id="2f92b-120">Located in the folder **Web API Helper Code**, these files comprise the supplemental library detailed in [Use the Dynamics 365 for Customer Engagement Web API Helper Library (C#)](use-microsoft-dynamics-365-web-api-helper-library-csharp.md).</span><span class="sxs-lookup"><span data-stu-id="2f92b-120">Located in the folder **Web API Helper Code**, these files comprise the supplemental library detailed in [Use the Dynamics 365 for Customer Engagement Web API Helper Library (C#)](use-microsoft-dynamics-365-web-api-helper-library-csharp.md).</span></span> |
| <span data-ttu-id="2f92b-121">BasicOperations.sln</span><span class="sxs-lookup"><span data-stu-id="2f92b-121">BasicOperations.sln</span></span> <br /><span data-ttu-id="2f92b-122">BasicOperations.csproj</span><span class="sxs-lookup"><span data-stu-id="2f92b-122">BasicOperations.csproj</span></span> <br /><span data-ttu-id="2f92b-123">Packages.config</span><span class="sxs-lookup"><span data-stu-id="2f92b-123">Packages.config</span></span> <br /><span data-ttu-id="2f92b-124">AssemblyInfo.cs</span><span class="sxs-lookup"><span data-stu-id="2f92b-124">AssemblyInfo.cs</span></span> |        <span data-ttu-id="2f92b-125">The standard [!INCLUDE[pn_microsoft_visual_studio_2015](../../includes/pn-microsoft-visual-studio-2015.md)] solution, project, NuGet package configuration, and assembly information files for this sample.</span><span class="sxs-lookup"><span data-stu-id="2f92b-125">The standard [!INCLUDE[pn_microsoft_visual_studio_2015](../../includes/pn-microsoft-visual-studio-2015.md)] solution, project, NuGet package configuration, and assembly information files for this sample.</span></span>        |

 <span data-ttu-id="2f92b-126">Next, use the following procedure to run this sample.</span><span class="sxs-lookup"><span data-stu-id="2f92b-126">Next, use the following procedure to run this sample.</span></span>  

1. <span data-ttu-id="2f92b-127">Locate and double-click on the solution file, BasicOperations.sln, to load the solution into [!INCLUDE[pn_Visual_Studio_short](../../includes/pn-visual-studio-short.md)].</span><span class="sxs-lookup"><span data-stu-id="2f92b-127">Locate and double-click on the solution file, BasicOperations.sln, to load the solution into [!INCLUDE[pn_Visual_Studio_short](../../includes/pn-visual-studio-short.md)].</span></span> <span data-ttu-id="2f92b-128">Build the **BasicOperations** solution.</span><span class="sxs-lookup"><span data-stu-id="2f92b-128">Build the **BasicOperations** solution.</span></span>  <span data-ttu-id="2f92b-129">This should automatically download and install all the required NuGet packages that are either missing or need to be updated.</span><span class="sxs-lookup"><span data-stu-id="2f92b-129">This should automatically download and install all the required NuGet packages that are either missing or need to be updated.</span></span>  

2. <span data-ttu-id="2f92b-130">Edit the application configuration file, App.config, to specify connection information for your Dynamics 365 for Customer Engagement server.</span><span class="sxs-lookup"><span data-stu-id="2f92b-130">Edit the application configuration file, App.config, to specify connection information for your Dynamics 365 for Customer Engagement server.</span></span>  <span data-ttu-id="2f92b-131">For more information, see [Helper code: Configuration classes](web-api-helper-code-configuration-classes.md).</span><span class="sxs-lookup"><span data-stu-id="2f92b-131">For more information, see [Helper code: Configuration classes](web-api-helper-code-configuration-classes.md).</span></span>  

3. <span data-ttu-id="2f92b-132">Run the **BasicOperations** project from within [!INCLUDE[pn_Visual_Studio_short](../../includes/pn-visual-studio-short.md)].</span><span class="sxs-lookup"><span data-stu-id="2f92b-132">Run the **BasicOperations** project from within [!INCLUDE[pn_Visual_Studio_short](../../includes/pn-visual-studio-short.md)].</span></span>  <span data-ttu-id="2f92b-133">All sample solutions are configured to run in debug mode by default.</span><span class="sxs-lookup"><span data-stu-id="2f92b-133">All sample solutions are configured to run in debug mode by default.</span></span>  

<a name="bkmk_codeListing"></a>   
## <a name="code-listing"></a><span data-ttu-id="2f92b-134">Code listing</span><span class="sxs-lookup"><span data-stu-id="2f92b-134">Code listing</span></span>  
 <span data-ttu-id="2f92b-135">The most current source for this file  is found in sample download package.</span><span class="sxs-lookup"><span data-stu-id="2f92b-135">The most current source for this file  is found in sample download package.</span></span>  
...
### <a name="see-also"></a><span data-ttu-id="2f92b-136">Xem thêm</span><span class="sxs-lookup"><span data-stu-id="2f92b-136">See also</span></span>  
 <span data-ttu-id="2f92b-137">[Use the Dynamics 365 for Customer Engagement Web API](../use-microsoft-dynamics-365-web-api.md) </span><span class="sxs-lookup"><span data-stu-id="2f92b-137">[Use the Dynamics 365 for Customer Engagement Web API](../use-microsoft-dynamics-365-web-api.md) </span></span>  
 <span data-ttu-id="2f92b-138">[Create an entity using the Web API](create-entity-web-api.md) </span><span class="sxs-lookup"><span data-stu-id="2f92b-138">[Create an entity using the Web API](create-entity-web-api.md) </span></span>  
 <span data-ttu-id="2f92b-139">[Update and delete entities using the Web API](update-delete-entities-using-web-api.md) </span><span class="sxs-lookup"><span data-stu-id="2f92b-139">[Update and delete entities using the Web API](update-delete-entities-using-web-api.md) </span></span>  
 <span data-ttu-id="2f92b-140">[Retrieve an entity using the Web API](retrieve-entity-using-web-api.md) </span><span class="sxs-lookup"><span data-stu-id="2f92b-140">[Retrieve an entity using the Web API](retrieve-entity-using-web-api.md) </span></span>  
 <span data-ttu-id="2f92b-141">[Update and delete entities using the Web API](update-delete-entities-using-web-api.md) </span><span class="sxs-lookup"><span data-stu-id="2f92b-141">[Update and delete entities using the Web API](update-delete-entities-using-web-api.md) </span></span>  
 <span data-ttu-id="2f92b-142">[Web API Samples](web-api-samples.md) </span><span class="sxs-lookup"><span data-stu-id="2f92b-142">[Web API Samples](web-api-samples.md) </span></span>  
 <span data-ttu-id="2f92b-143">[Web API Basic Operations Sample](web-api-basic-operations-sample.md) [Web API Query Data Sample (C#)](web-api-query-data-sample-csharp.md) </span><span class="sxs-lookup"><span data-stu-id="2f92b-143">[Web API Basic Operations Sample](web-api-basic-operations-sample.md) [Web API Query Data Sample (C#)](web-api-query-data-sample-csharp.md) </span></span>  
 <span data-ttu-id="2f92b-144">[Web API Conditional Operations Sample (C#)](web-api-conditional-operations-sample-csharp.md) </span><span class="sxs-lookup"><span data-stu-id="2f92b-144">[Web API Conditional Operations Sample (C#)](web-api-conditional-operations-sample-csharp.md) </span></span>  
 [<span data-ttu-id="2f92b-145">Web API Functions and Actions Sample (C#)</span><span class="sxs-lookup"><span data-stu-id="2f92b-145">Web API Functions and Actions Sample (C#)</span></span>](web-api-functions-actions-sample-csharp.md)
