...
ms.locfileid: "388478"
---
# <a name="web-api-basic-operations-sample-c"></a>Web API Basic Operations Sample (C#)
...
## <a name="run-this-sample"></a>Run this sample  
...
## <a name="code-listing"></a>Code listing  
...
### <a name="see-also"></a>Xem thêm  
 ...
 [Web API Basic Operations Sample](web-api-basic-operations-sample.md) [Web API Query Data Sample (C#)](web-api-query-data-sample-csharp.md)   
