...
ms.locfileid: "388086"
---
# <a name="web-api-functions-and-actions-sample-client-side-javascript"></a>Web API Functions and Actions Sample (Client-side JavaScript)
...
-   [Điều kiện tiên quyết](#bkmk_prerequisites)  
