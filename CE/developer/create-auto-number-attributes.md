...
ms.locfileid: "388235"
---
# <a name="create-auto-number-attributes"></a>Create auto-number attributes
...
## <a name="use-web-api"></a>Use Web API
...
## <a name="autonumberformat-options"></a>AutoNumberFormat options
...
## <a name="update-auto-number-attributes"></a>Update auto-number attributes
...
## <a name="set-a-seed-value"></a>Set a seed value
...
|**Tên**|**Loại**|**Mô tả**|
|:----------|:----------|:----------|
|EntityName|chuỗi|The logical name of the entity that contains the attribute you want to set the seed on.|
|AttributeName|chuỗi|The logical name of the attribute you want to set the seed on.|
