...
ms.locfileid: "387443"
---
# <a name="configure-activity-feeds"></a>Configure activity feeds
...
## <a name="configuration-entities"></a>Configuration entities  
...
## <a name="auto-post-rules"></a>Auto post rules  
...
## <a name="plug-ins-and-workflows"></a>Plug-ins and workflows  
...
## <a name="wall-controls"></a>Wall controls  
...
<a name="Exception"></a>   
## <a name="lookup-information-for-the-post-entity-and-post-follow-entity"></a>Lookup information for the post entity and post follow entity  
...
### <a name="see-also"></a>Xem thêm  
 [msdyn_PostConfig Entity](entities/msdyn_postconfig.md) [msdyn_PostRuleConfig Entity](entities/msdyn_postruleconfig.md) [Activity Feeds Entities](activity-feeds-entities.md)   
