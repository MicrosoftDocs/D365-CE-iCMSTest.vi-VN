...
ms.locfileid: "386023"
---
# <a name="getglobalcontext-function-and-clientglobalcontextjsaspx-client-api-reference"></a>GetGlobalContext function and ClientGlobalContext.js.aspx (Client API reference)
...
## <a name="getglobalcontext-function"></a>GetGlobalContext function
...
- If you are not using backslash characters in HTML web resource names to simulate a folder structure, you can include this script by directly referring to it. Ví dụ:
