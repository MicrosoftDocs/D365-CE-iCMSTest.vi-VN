...
ms.locfileid: "386224"
---
# <a name="openform-client-api-reference"></a>openForm (Client API reference)
...
### <a name="example-1-open-an-entity-form-for-existing-record"></a>Example 1: Open an entity form for existing record
...
### <a name="example-2-open-an-entity-form-for-new-record"></a>Example 2: Open an entity form for new record
...
### <a name="example-3-open-a-quick-create-form"></a>Example 3: Open a quick create form
