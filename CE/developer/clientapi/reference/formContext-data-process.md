...
ms.locfileid: "386717"
---
# <a name="formcontextdataprocess-client-api-reference"></a>formContext.data.process (Client API reference)
...
## <a name="process-events-and-event-handler-methods"></a>Process events and event handler methods

Use the following events and event handler methods to write scripts for business process flows.

|Sự kiện | Event handler methods|
|--|--|
...
## <a name="active-process-methods"></a>Active Process methods
...
## <a name="process-methods"></a>Process methods 
...
## <a name="processinstance-methods"></a>ProcessInstance methods
...
## <a name="active-stage-methods"></a>Active Stage methods
...
## <a name="stage-methods"></a>Stage methods 
...
## <a name="step-methods"></a>Step methods
...
## <a name="navigation-methods"></a>Navigation methods
...
## <a name="other-useful-methods"></a>Other useful methods
