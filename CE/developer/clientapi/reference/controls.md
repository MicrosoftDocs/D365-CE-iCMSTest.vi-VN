...
ms.locfileid: "386763"
---
# <a name="controls-client-api-reference"></a>Controls (Client API reference)
...
## <a name="standard-control-type"></a>standard control type
...
## <a name="iframe-control-type"></a>iframe control type
...
## <a name="kbsearch-knowledge-base-search-control-type"></a>kbsearch (Knowledge base search) control type
...
## <a name="lookup-control-type"></a>lookup control type
...
## <a name="multiselectoptionset-and-optionset-control-types"></a>multiselectoptionset and optionset control types
...
## <a name="timer-control-type"></a>timer control type
...
## <a name="webresource-control-type"></a>webresource control type
