...
ms.locfileid: "388016"
---
# <a name="retrievemultiplerecords-client-api-reference"></a>retrieveMultipleRecords (Client API reference)
...
### <a name="basic-retrieve-multiple"></a>Basic retrieve multiple
