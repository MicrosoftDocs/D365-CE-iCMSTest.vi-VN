...
<li><b>operationType</b>: (Optional). Số. Indicates the type of operation you are executing; specify one of the following values:
...
### <a name="execute-an-action"></a>Execute an action
...
### <a name="execute-a-function"></a>Execute a function
