...
ms.locfileid: "388778"
---
# <a name="updaterecord-client-api-reference"></a>updateRecord (Client API reference)
...
### <a name="update-associations-to-the-related-entities"></a>Update associations to the related entities
