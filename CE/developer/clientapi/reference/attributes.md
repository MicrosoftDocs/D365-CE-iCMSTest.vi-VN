...
ms.locfileid: "388636"
---
# <a name="attributes-client-api-reference"></a>Attributes (Client API reference)
...
To access an attribute within the collection, you pass either the name (string) or the index value (number) of the attribute as an argument to the method. Ví dụ: `formContext.getAttribute(arg)`
...
## <a name="all-attribute-types"></a>All attribute types
...
## <a name="boolean-attribute-type"></a>Boolean attribute type
...
## <a name="lookup-attribute-type"></a>Lookup attribute type
...
## <a name="multiselectoptionset-and-optionset-attribute-types"></a>MultiSelectOptionSet and OptionSet attribute types
...
## <a name="number-attribute-type-decimal-double-integer-money"></a>Number attribute type (decimal, double, integer, money)
...
## <a name="string-attribute-type"></a>String attribute type
