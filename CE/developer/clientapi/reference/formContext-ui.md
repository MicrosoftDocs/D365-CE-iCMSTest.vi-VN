...
ms.locfileid: "386474"
---
# <a name="formcontextui-client-api-reference"></a>formContext.ui (Client API reference)
...
|Tên|Mô tả|
|--|--|
|Kiểm soát|Collection of all the controls on the page. See [Collections](collections.md) for information about the collections and [Controls](controls.md) for information about the control objects in the collection.|
