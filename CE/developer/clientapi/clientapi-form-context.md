...
ms.locfileid: "388558"
---
# <a name="client-api-form-context"></a>Client API form context
...
## <a name="using-the-formcontext-object-instead-of-the-xrmpage-object"></a>Using the formContext object instead of the Xrm.Page object 
...
## <a name="formcontext-object-model"></a>formContext object model
...
| **Đối tượng**  | **Mô tả**|
|-----------------|----------------|
|thực thể|Provides methods to retrieve information specific to the record displayed on the page, the save method, and a collection of all the attributes included on the form|
...
## <a name="collections-in-the-formcontext-object-model"></a>Collections in the formContext object model

The following table describes the collections in **Xrm** object model. For information about the methods available for collections in general, see [Collections (Client API reference)](reference/collections.md).
