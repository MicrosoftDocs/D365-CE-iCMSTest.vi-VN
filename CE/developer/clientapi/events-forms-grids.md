...
ms.locfileid: "386490"
---
# <a name="events-in-forms-and-grids-in-customer-engagement"></a>Events in forms and grids in Customer Engagement
...
## <a name="add-or-remove-event-handler-function-to-event-using-ui"></a>Add or remove event handler function to event using UI
...
## <a name="add-or-remove-event-handler-function-to-event-using-code"></a>Add or remove event handler function to event using code
...
## <a name="form-event-pipeline"></a>Form event pipeline
