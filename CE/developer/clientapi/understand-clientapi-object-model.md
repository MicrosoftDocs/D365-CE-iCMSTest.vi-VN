...
ms.locfileid: "387942"
---
# <a name="understand-the-client-api-object-model"></a>Understand the Client API object model
...
## <a name="root-objects-in-the-client-api-object-model"></a>Root objects in the Client API object model
...
|**formContext** |Provides a reference to a form or an item on the form against which the current code executes. To get the **formContext** object, use the **executionContext**.[getFormContext](reference/executioncontext/getFormContext.md) method.<br/>Thông tin khác: [Ngữ cảnh biểu mẫu API máy khách](clientapi-form-context.md)|
