...
ms.locfileid: "385667"
---
# <a name="walkthrough-write-your-first-client-script"></a>Walkthrough: Write your first client script

[!INCLUDE[](../../includes/cc_applies_to_update_9_0_0.md)]

Ready to write your first client script to see things in action. Lets get started; we'll keep it simple.

## <a name="objective"></a>Mục tiêu
...
## <a name="step-1-write-your-custom-javascript-code"></a>Step 1: Write your custom JavaScript code
...
### <a name="detailed-code-explanation"></a>Detailed code explanation
...
## <a name="step-2-add-your-javascript-code-in-a-script-web-resource"></a>Step 2: Add your JavaScript code in a Script web resource
...
## <a name="step-3-associate-script-web-resource-to-a-form"></a>Step 3: Associate Script web resource to a form
...
## <a name="test-your-javascript-code"></a>Test your JavaScript code
...
## <a name="complete-sample-code-used-in-the-walkthrough"></a>Complete sample code used in the walkthrough
