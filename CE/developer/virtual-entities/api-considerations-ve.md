...
ms.locfileid: "387186"
---
# <a name="api-considerations-of-virtual-entities"></a>API considerations of virtual entities
...
## <a name="new-dynamics-365-for-customer-engagement-data-sdk-assembly"></a>New Dynamics 365 for Customer Engagement Data SDK assembly
...
## <a name="changes-to-the-core-platform"></a>Changes to the core platform
...
### <a name="new-web-api-types"></a>New Web API types
...
### <a name="new-metadata-properties"></a>New metadata properties
...
### <a name="virtual-entity-creation"></a>Virtual entity creation
...
### <a name="entity-metadata-property-behavior-changes"></a>Entity metadata property behavior changes
...
|**Metadata Property**|**Applies?**|**Ghi chú**|
|---------------------|------------|---------|
...
|Khóa|_invalid_|Alternate keys are not supported|
...
### <a name="attribute-metadata-property-behavior-changes"></a>Attribute metadata property behavior changes
