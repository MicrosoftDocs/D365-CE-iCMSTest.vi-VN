...
ms.locfileid: "385812"
---
# <a name="custom-virtual-entity-data-providers"></a>Custom virtual entity data providers
...
## <a name="categories-of-providers"></a>Categories of providers
...
## <a name="steps-to-use-a-custom-data-provider"></a>Steps to use a custom data provider
...
### <a name="plug-in-development"></a>Plug-in development
...
#### <a name="data-provider-exceptions"></a>Data provider exceptions
