...
ms.locfileid: "385447"
---
# <a name="about-the-microsoft-cloud-australia-datacenter"></a>About the Microsoft Cloud Australia datacenter
...
## <a name="australia-geo-expansion-announcement"></a>Australia GEO expansion announcement  
  
### <a name="what-is-microsoft-announcing"></a>What is Microsoft announcing?  
...
### <a name="what-prompted-microsoft-to-undertake-this-geographic-expansion-of-dynamics-365-for-customer-engagement-apps-online"></a>What prompted Microsoft to undertake this geographic expansion of Dynamics 365 for Customer Engagement apps (online)?  
...
### <a name="what-are-the-future-geographic-expansion-plans-for-dynamics-365-for-customer-engagement-apps-online"></a>What are the future geographic expansion plans for Dynamics 365 for Customer Engagement apps (online)?  
...
## <a name="datacenter-overview"></a>Datacenter overview  
  
### <a name="where-are-the-datacenters-located-in-the-australia-geo"></a>Where are the datacenters located in the Australia Geo?  
...
### <a name="what-does-this-announcement-mean-for-customers-in-the-australia-geo"></a>What does this announcement mean for customers in the Australia Geo?  
...
### <a name="what-region-will-be-used-for-replication-of-data-for-the-australia-geo"></a>What region will be used for replication of data for the Australia Geo?  
...
### <a name="how-do-i-find-what-country-or-region-my-account-is-under"></a>How do I find what country or region my account is under?  
...
## <a name="dynamics-365-for-customer-engagement-apps-online-service-overview"></a>Dynamics 365 for Customer Engagement apps (online) service overview  
  
### <a name="will-multi-geo-instances-be-available-to-customers-in-australia"></a>Will multi-geo instances be available to customers in Australia?  
...
### <a name="will-the-standard-dynamics-365-for-customer-engagement-apps-online-sla-be-offered-at-general-availability-launch"></a>Will the standard Dynamics 365 for Customer Engagement apps Online SLA be offered at general availability launch?  
...
### <a name="what-rules-govern-new-zealand-or-oceania-customers-who-want-to-license-affiliates-located-in-australia"></a>What rules govern New Zealand or Oceania customers who want to license affiliates located in Australia?  
...
### <a name="will-microsoft-dynamics-marketing-social-engagement-and-parature-be-available-in-the-australia-datacenters"></a>Will Microsoft Dynamics Marketing, Social Engagement, and Parature be available in the Australia datacenters?  
...
### <a name="will-dynamics-365-for-customer-engagement-apps-be-available-on-azure-infrastructure-as-a-service-iaas-in-australia"></a>Will Dynamics 365 for Customer Engagement apps be available on Azure Infrastructure as a Service (IaaS) in Australia?  
...
### <a name="where-can-i-find-more-about-dynamics-365-for-customer-engagement-apps-online-security-data-privacy-and-compliance"></a>Where can I find more about Dynamics 365 for Customer Engagement apps (online) security, data privacy, and compliance?  
...
### <a name="what-data-for-dynamics-365-for-customer-engagement-apps-online-will-be-in-australia-datacenters-at-general-availability"></a>What data for Dynamics 365 for Customer Engagement apps (online) will be in Australia datacenters at general availability?  
...
### <a name="where-can-i-find-out-more-about-the-physical-infrastructure-for-dynamics-365-for-customer-engagement-apps-online"></a>Where can I find out more about the physical infrastructure for Dynamics 365 for Customer Engagement apps (online)?  
...
### <a name="i-have-applications-and-data-in-an-existing-microsoft-dynamics-365-for-customer-engagement-apps-online-datacenter-will-i-be-able-to-move-those-resources-to-the-australia-datacenters"></a>I have applications and data in an existing Microsoft Dynamics 365 for Customer Engagement apps (online) datacenter. Will I be able to move those resources to the Australia datacenters?  
...
### <a name="how-do-i-request-my-instance-to-be-moved-to-the-australia-datacenter"></a>How do I request my instance to be moved to the Australia datacenter?  
...
### <a name="how-will-microsoft-engage-with-me-on-the-migration"></a>How will Microsoft engage with me on the migration?  
...
### <a name="if-i-am-scheduled-for-an-update-to-crm-online-2015-update-or-crm-online-2015-update-1-will-microsoft-apply-the-update-at-the-same-time-as-their-migration-to-the-australia-datacenter"></a>If I am scheduled for an update to CRM Online 2015 Update or CRM Online 2015 Update 1, will Microsoft apply the update at the same time as their migration to the Australia datacenter?  
...
### <a name="if-i-have-both-office-365-services-and-dynamics-365-for-customer-engagement-apps-online-how-will-migration-be-handled"></a>If I have both Office 365 services and Dynamics 365 for Customer Engagement apps (online), how will migration be handled?  
...
### <a name="can-i-move-office-365-and-dynamics-365-for-customer-engagement-apps-online-at-the-same-time"></a>Can I move Office 365 and Dynamics 365 for Customer Engagement apps (online) at the same time?  
...
### <a name="will-all-versions-of-dynamics-365-for-customer-engagement-apps-online-be-available"></a>Will all versions of Dynamics 365 for Customer Engagement apps Online be available?  
...
### <a name="will-customers-who-purchase-dynamics-crm-online-and-an-additional-service-such-as-parature-dynamics-marketing-or-microsoft-social-engagement-be-taxed-differently-per-service"></a>Will customers who purchase Dynamics CRM Online and an additional service such as Parature, Dynamics Marketing, or Microsoft Social Engagement be taxed differently per service?  
...
<a name="BKMK_Tax"></a>   
## <a name="tax-and-billing"></a>Tax and billing  
  
### <a name="will-there-be-any-changes-on-my-bill"></a>Will there be any changes on my bill?  
...
### <a name="my-tenant-has-not-moved-to-australia-datacenter-why-am-i-being-charged-australia-goods-and-service-tax-gst"></a>My tenant has not moved to Australia datacenter, why am I being charged Australia Goods and Service Tax (GST)?  
...
## <a name="trials"></a>Trials  
  
### <a name="if-i-started-a-trial-outside-of-australia-and-before-general-availability-will-i-be-moved-to-the-australia-datacenter-after-general-availability"></a>If I started a trial outside of Australia and before general availability, will I be moved to the Australia datacenter after general availability?  
 Không. Trials will remain in the geography where they were initiated. You may choose to start a new trial that would be provisioned in the Australia datacenter.  
  
### <a name="if-i-choose-to-convert-a-trial-to-a-paid-subscription-where-the-trial-was-created-in-a-geographic-region-outside-of-australia-prior-to-general-availability-will-my-subscription-tenant-and-instance-be-moved-to-the-australia-datacenter"></a>If I choose to convert a trial to a paid subscription, where the trial was created in a geographic region outside of Australia prior to general availability, will my subscription tenant and instance be moved to the Australia datacenter?  
 Không. If you choose to convert a trial that was created in a geographic region outside of Australia before general availability, your trial will be converted and billed in the geography where it was initiated. Australia GST does not apply.  
...
### <a name="if-a-customer-creates-a-trial-in-the-australia-datacenter-after-general-availability-will-they-be-taxed-for-the-trial"></a>If a customer creates a trial in the Australia datacenter after general availability, will they be taxed for the trial?  
 Không. Trials are free for 30 days.  
  
### <a name="can-i-create-a-trial-in-the-australia-datacenter-before-general-availability"></a>Can I create a trial in the Australia datacenter before general availability?  
 Không. You can’t create a trial or move a Production instance before general availability.  
