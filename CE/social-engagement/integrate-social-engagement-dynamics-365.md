...
ms.locfileid: "375438"
---
# <a name="integrate-includepnnetbreezeshortincludespn-social-engagement-shortmd-with-dynamics-365-for-customer-engagement-apps"></a>Integrate [!INCLUDE[pn_netbreeze_short](../includes/pn-social-engagement-short.md)] with Dynamics 365 for Customer Engagement apps
...
## <a name="connect-the-dynamics-365-for-customer-engagement-service-to-includepnnetbreezeshortincludespn-social-engagement-shortmd-for-social-insights"></a>Connect the Dynamics 365 for Customer Engagement service to [!INCLUDE[pn_netbreeze_short](../includes/pn-social-engagement-short.md)] for Social Insights
...
### <a name="connect-to-includepnnetbreezeshortincludespn-social-engagement-shortmd"></a>Connect to [!INCLUDE[pn_netbreeze_short](../includes/pn-social-engagement-short.md)]
...
## <a name="connect-the-dynamics-365-for-customer-engagement-on-premises-service-to-includepnnetbreezeshortincludespn-social-engagement-shortmd-for-social-insights"></a>Connect the Dynamics 365 for Customer Engagement on-premises service to [!INCLUDE[pn_netbreeze_short](../includes/pn-social-engagement-short.md)] for Social Insights
...
### <a name="connect-dynamics-365-for-customer-engagement-on-premises-to-includepnnetbreezeshortincludespn-social-engagement-shortmd"></a>Connect Dynamics 365 for Customer Engagement on-premises to [!INCLUDE[pn_netbreeze_short](../includes/pn-social-engagement-short.md)]
...
## <a name="add-includepnnetbreezeshortincludespn-social-engagement-shortmd-visuals-to-an-entity-form"></a>Add [!INCLUDE[pn_netbreeze_short](../includes/pn-social-engagement-short.md)] visuals to an entity form
...
## <a name="add-includepnnetbreezeshortincludespn-social-engagement-shortmd-visuals-to-dashboards"></a>Add [!INCLUDE[pn_netbreeze_short](../includes/pn-social-engagement-short.md)] visuals to dashboards
...
## <a name="configure-forms-add-and-configure-social-insights-controls"></a>Configure forms: Add and configure Social Insights controls

### <a name="add-a-social-insights-control-to-an-entity-form"></a>Add a Social Insights control to an entity form
...
### <a name="configure-social-insights-visuals-on-entity-forms"></a>Configure Social Insights visuals on entity forms

#### <a name="change-the-configuration-of-social-insights-in-the-web-client"></a>Change the configuration of Social Insights in the web client
...
#### <a name="change-the-configuration-of-social-insights-in-unified-interface-apps"></a>Change the configuration of Social Insights in Unified Interface apps
...
## <a name="set-up-search-topics-from-within-dynamics-365-for-customer-engagement-apps"></a>Set up search topics from within Dynamics 365 for Customer Engagement apps  
...
## <a name="reset-social-insights"></a>Reset Social Insights
