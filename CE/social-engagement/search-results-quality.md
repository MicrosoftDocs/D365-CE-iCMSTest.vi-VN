...
ms.locfileid: "375540"
---
# <a name="manage-the-quality-of-your-search-results"></a>Manage the quality of your search results
...
## <a name="block-domains-from-your-sources"></a>Block domains from your sources  
...
### <a name="view-blocked-domains"></a>View blocked domains  
...
### <a name="block-a-domain-from-your-searches"></a>Block a domain from your searches  
...
### <a name="remove-a-domain-from-the-list-of-blocked-sources"></a>Remove a domain from the list of blocked sources  
...
## <a name="block-keywords-and-terms-from-your-searches"></a>Block keywords and terms from your searches  
...
### <a name="view-excluded-keywords"></a>View excluded keywords  
...
### <a name="block-keywords-from-your-search-results"></a>Block keywords from your search results  
...
### <a name="remove-a-keyword-from-blocked-content"></a>Remove a keyword from blocked content  
...
## <a name="manage-the-data-acquisition-volume"></a>Manage the data acquisition volume  
