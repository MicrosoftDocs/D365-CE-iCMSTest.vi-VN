...
ms.locfileid: "375481"
---
# <a name="work-with-posts"></a>Work with posts
...
<a name="sentiment"></a>   
## <a name="change-a-posts-sentiment-value-in-analytics-and-social-center"></a>Change a post’s sentiment value in Analytics and Social Center  
...
<a name="labels"></a>   
## <a name="add-a-label-to-a-post-in-analytics-or-social-center"></a>Add a label to a post in Analytics or Social Center  
...
<a name="assignTo"></a>   
## <a name="assign-a-post-to-other-users-in-analytics-and-social-center"></a>Assign a post to other users in Analytics and Social Center  
...
## <a name="add-or-remove-tags"></a>Add or remove tags  
...
### <a name="delete-posts-in-analytics"></a>Delete posts in Analytics  
...
### <a name="delete-posts-in-streams"></a>Delete posts in streams  
...
<a name="link_post"></a>   
## <a name="link-a-post-from-includepnnetbreezeshortincludespn-social-engagement-shortmd-to-dynamics-365-for-customer-engagement"></a>Link a post from [!INCLUDE[pn_netbreeze_short](../includes/pn-social-engagement-short.md)] to Dynamics 365 for Customer Engagement  
