...
ms.locfileid: "375575"
---
# <a name="understand-user-roles"></a>Understand user roles
...
## <a name="configuration-user-roles"></a>Configuration user roles  
...
## <a name="interaction-user-roles"></a>Interaction user roles  
