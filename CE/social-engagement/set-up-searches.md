...
ms.locfileid: "375707"
---
# <a name="set-up-searches-to-listen-to-social-media-conversations"></a>Set up searches to listen to social media conversations
...
## <a name="walkthrough-create-refine-and-analyze-a-search-topic"></a>Walkthrough: Create, refine, and analyze a search topic  
...
## <a name="access-search-topics"></a>Access search topics  
...
## <a name="available-languages-for-search-rules"></a>Available languages for search rules  
