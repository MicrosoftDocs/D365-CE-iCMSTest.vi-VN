...
ms.locfileid: "375694"
---
# <a name="manage-global-settings"></a>Manage global settings
...
## <a name="edit-the-solution-name"></a>Edit the solution name  
...
## <a name="edit-the-default-screen-language"></a>Edit the default screen language  
...
## <a name="edit-the-default-time-frame"></a>Edit the default time frame  
...
## <a name="edit-the-default-date-and-time-format"></a>Edit the default date and time format  
...
## <a name="edit-the-number-format"></a>Edit the number format  
...
## <a name="add-or-remove-search-languages"></a>Add or remove search languages  
 You can select the languages you want to have available when you set up or edit a keyword search rule in a search topic.  
  
### <a name="add-search-languages"></a>Add search languages  
...
### <a name="remove-search-languages"></a>Remove search languages  
...
## <a name="define-defaults-for-new-search-topics"></a>Define defaults for new search topics  
...
## <a name="link-to-a-custom-privacy-statement"></a>Link to a custom privacy statement  
...
## <a name="turn-adaptive-learning-on"></a>Turn adaptive learning on  
...
## <a name="manage-labels-for-posts"></a>Manage labels for posts  
...
## <a name="create-and-manage-location-groups"></a>Create and manage location groups  
...
### <a name="find-available-location-groups"></a>Find available location groups  
...
### <a name="create-a-custom-location-group"></a>Create a custom location group  
...
### <a name="edit-a-custom-location-group"></a>Edit a custom location group  
...
### <a name="delete-a-custom-location-group"></a>Delete a custom location group  
...
## <a name="promote-custom-tags-to-auto-tags"></a>Promote custom tags to auto tags  
