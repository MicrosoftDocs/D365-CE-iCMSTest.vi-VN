...
ms.locfileid: "375674"
---
# <a name="work-with-events-from-includepnnetbreezeshortincludespn-social-engagement-shortmd-in-azure-event-hubs"></a>Work with events from [!INCLUDE[pn_netbreeze_short](../includes/pn-social-engagement-short.md)] in Azure Event Hubs
...
## <a name="analyze-social-posts-in-real-time-with-power-bi"></a>Analyze social posts in real time with Power BI  
...
### <a name="step-2-connect-includepnnetbreezeshortincludespn-social-engagement-shortmd-to-the-event-hub"></a>Step 2: Connect [!INCLUDE[pn_netbreeze_short](../includes/pn-social-engagement-short.md)] to the event hub  
...
### <a name="step-3-create-an-automation-rule-to-select-the-posts-that-get-streamed-to-the-event-hub"></a>Step 3: Create an automation rule to select the posts that get streamed to the event hub  
...
### <a name="step-4-create-an-azure-stream-analytics-job"></a>Step 4: Create an Azure Stream Analytics job  
...
### <a name="step-5-create-a-dashboard-in-power-bi"></a>Step 5: Create a dashboard in Power BI  
