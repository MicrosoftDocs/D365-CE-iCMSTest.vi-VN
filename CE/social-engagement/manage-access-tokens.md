...
ms.locfileid: "375608"
---
# <a name="manage-access-tokens"></a>Manage access tokens
...
## <a name="tokens-for-data-acquisition"></a>Tokens for data acquisition  
...
### <a name="add-a-facebook-acquisition-token-and-allow-data-acquisition"></a>Add a Facebook acquisition token and allow data acquisition  
...
## <a name="tokens-for-interactions-with-posts"></a>Tokens for interactions with posts 
...
### <a name="add-a-facebook-page-token-and-allow-data-acquisition-for-private-messages"></a>Add a Facebook page token and allow data acquisition for private messages  
...
### <a name="add-a-twitter-token-and-allow-data-acquisition-for-private-messages"></a>Add a Twitter token and allow data acquisition for private messages  
...
## <a name="reauthenticate-a-token"></a>Reauthenticate a token 
...
## <a name="delete-tokens"></a>Delete tokens  
