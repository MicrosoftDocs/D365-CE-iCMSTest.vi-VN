...
ms.locfileid: "375505"
---
# <a name="set-up-includepnnetbreezelongincludespn-social-engagement-longmd"></a>Set up [!INCLUDE[pn_netbreeze_long](../includes/pn-social-engagement-long.md)]
...
## <a name="define-global-settings"></a>Define global settings  
...
## <a name="set-up-your-first-search-topic-and-add-rules"></a>Set up your first search topic and add rules  
