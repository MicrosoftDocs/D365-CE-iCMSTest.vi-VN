...
<a name="elements"></a>   
## <a name="elements-of-an-automation-rule"></a>Elements of an automation rule  
...
<a name="actions"></a>   
## <a name="available-actions-for-automation-rules"></a>Available actions for automation rules  
...
### <a name="create-a-link-to-dynamics-365-for-customer-engagement-from-a-social-post"></a>Create a link to Dynamics 365 for Customer Engagement from a social post  
...
### <a name="assign-posts-to-a-user-or-a-group-in-includepnnetbreezeshortincludespn-social-engagement-shortmd"></a>Assign posts to a user or a group in [!INCLUDE[pn_netbreeze_short](../includes/pn-social-engagement-short.md)]  
...
<a name="set_label"></a>   
### <a name="set-a-label"></a>Set a label  
...
### <a name="stream-posts-to-microsoft-azure-event-hubs"></a>Stream posts to Microsoft Azure Event Hubs  
...
## <a name="troubleshoot-issues-with-failing-actions"></a>Troubleshoot issues with failing actions  
...
### <a name="link-to-dynamics-365-action-fails"></a>Link to Dynamics 365 action fails  
**Possible causes**  
...
### <a name="stream-to-event-hubs-action-fails"></a>Stream to Event Hubs action fails  
**Possible causes**  
...
## <a name="create-edit-or-delete-an-automation-rule"></a>Create, edit, or delete an automation rule  
...
### <a name="create-an-automation-rule"></a>Create an automation rule  
...
<a name="edit_rule"></a>   
### <a name="edit-an-automation-rule"></a>Edit an automation rule  
...
### <a name="delete-an-automation-rule"></a>Delete an automation rule  
...
## <a name="quickly-create-an-automation-rule-while-working-in-includepnnetbreezeshortincludespn-social-engagement-shortmd"></a>Quickly create an automation rule while working in [!INCLUDE[pn_netbreeze_short](../includes/pn-social-engagement-short.md)]  
...
## <a name="how-includepnnetbreezeshortincludespn-social-engagement-shortmd-handles-conflicting-automation-rules"></a>How [!INCLUDE[pn_netbreeze_short](../includes/pn-social-engagement-short.md)] handles conflicting automation rules  
