...
ms.locfileid: "375530"
---
# <a name="add-rules-to-a-search-topic"></a>Add rules to a search topic
...
[!INCLUDE[pn_netbreeze_short](../includes/pn-social-engagement-short.md)] supports the following search rules. You need to be a [!INCLUDE[pn_netbreeze_short](../includes/pn-social-engagement-short.md)] Administrator or Power Analyst to create or modify search topics.
...
## <a name="add-a-rule-to-a-search-topic"></a>Add a rule to a search topic  
...
### <a name="add-a-new-rule"></a>Add a new rule  
...
## <a name="add-a-keywords-rule"></a>Add a keywords rule  
...
### <a name="add-a-new-keywords-rule"></a>Add a new keywords rule  
...
### <a name="add-keywords-to-search-for"></a>Add keywords to search for  
...
### <a name="add-inclusions-to-a-keywords-rule"></a>Add inclusions to a keywords rule  
...
### <a name="exclude-terms-from-a-keywords-rule"></a>Exclude terms from a keywords rule  
...
### <a name="handle-special-characters-in-keywords-inclusions-and-exclusions"></a>Handle special characters in keywords, inclusions, and exclusions  
...
#### <a name="additional-special-characters"></a>Additional special characters  
...
### <a name="limitations-on-topic-names-keywords-inclusions-and-exclusions"></a>Limitations on topic names, keywords, inclusions, and exclusions  
...
## <a name="add-a-facebook-pages-rule"></a>Add a Facebook pages rule  
...
### <a name="add-a-new-facebook-pages-rule"></a>Add a new Facebook pages rule  
...
## <a name="add-a-twitter-rule"></a>Add a Twitter rule  
...
### <a name="add-a-new-twitter-rule"></a>Add a new Twitter rule  
...
## <a name="add-a-private-messages-rule"></a>Add a private messages rule  
...
### <a name="add-a-new-private-messages-rule"></a>Add a new private messages rule  
...
## <a name="add-a-custom-sources-rule"></a>Add a custom sources rule 
...
### <a name="add-a-new-custom-sources-rule"></a>Add a new custom sources rule  
...
## <a name="add-a-includetnyoutubeincludestn-youtubemd-rule"></a>Add a [!INCLUDE[tn_youtube](../includes/tn-youtube.md)] rule
...
## <a name="add-a-includepn-linkedinincludespn-linkedinmd-page-rule"></a>Add a [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)] page rule
