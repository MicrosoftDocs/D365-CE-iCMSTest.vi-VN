...
ms.locfileid: "375418"
---
# <a name="includepnnetbreezelongincludespn-social-engagement-longmd-faq"></a>[!INCLUDE[pn_netbreeze_long](../includes/pn-social-engagement-long.md)] FAQ
...
## <a name="how-can-i-respond-to-a-data-subject-request-dsr-in-context-of-gdpr"></a>How can I respond to a Data Subject Request (DSR) in context of GDPR?
...
## <a name="how-soon-will-i-start-seeing-data-after-i-set-up-a-search-topic"></a>How soon will I start seeing data after I set up a search topic? 
...
## <a name="what-are-my-options-if-i-am-reaching-my-quota-limit"></a>What are my options if I am reaching my quota limit?
...
## <a name="what-happens-if-i-exceed-my-post-quota"></a>What happens if I exceed my post quota?
...
## <a name="why-does-the-number-of-posts-in-search-setup-quota-differ-from-analytics"></a>Why does the number of posts in Search Setup Quota differ from Analytics?
...
## <a name="why-is-there-no-facebook-in-keyword-search"></a>Why is there no Facebook in keyword search?  
...
## <a name="on-what-level-can-i-filter-for-location-from-the-filter-section"></a>On what level can I filter for Location from the filter section? 
...
## <a name="why-cant-i-filter-on-the-top-cities-widget-in-the-location-dashboard"></a>Why can't I filter on the Top Cities widget in the Location dashboard?
  
We currently don't support filtering at the city level.  
  
## <a name="why-cant-i-see-the-original-post-on-some-of-the-news-posts-in-the-posts-view"></a>Why can't I see the original post on some of the News posts in the posts view?  
...
## <a name="is-there-a-limit-to-the-number-of-terms-or-phrases-that-can-be-used-in-a-keyword-search-rule"></a>Is there a limit to the number of terms or phrases that can be used in a keyword search rule?  
...
## <a name="does-your-sentiment-analysis-accurately-read-emoticons-or-emoji"></a>Does your sentiment analysis accurately read emoticons or emoji?  
