...
ms.locfileid: "375671"
---
# <a name="create-a-dynamics-365-for-customer-engagement-record-from-a-social-post"></a>Create a Dynamics 365 for Customer Engagement record from a social post
...
## <a name="specify-record-details"></a>Specify record details
...
### <a name="define-or-edit-fields-for-record-details"></a>Define or edit fields for record details
...
## <a name="convert-a-includepnnetbreezeshortincludespn-social-engagement-shortmd-post-to-a-social-activity"></a>Convert a [!INCLUDE[pn_netbreeze_short](../includes/pn-social-engagement-short.md)] post to a social activity
...
## <a name="configure-dynamics-365-for-customer-engagement-apps-to-automatically-create-records-from-linked-posts"></a>Configure Dynamics 365 for Customer Engagement apps to automatically create records from linked posts
...
## <a name="understand-the-data-sent-when-you-create-a-social-activity"></a>Understand the data sent when you create a social activity
...
## <a name="sample-payload"></a>Sample payload
...
## <a name="view-record-details-for-a-linked-post-in-includepnnetbreezeshortincludespn-social-engagement-shortmd"></a>View record details for a linked post in [!INCLUDE[pn_netbreeze_short](../includes/pn-social-engagement-short.md)]
...
### <a name="open-a-customer-engagement-record-from-within-includepnnetbreezeshortincludespn-social-engagement-shortmd"></a>Open a Customer Engagement record from within [!INCLUDE[pn_netbreeze_short](../includes/pn-social-engagement-short.md)]
...
## <a name="open-a-linked-record"></a>Open a linked record
...
## <a name="remove-a-linked-record-from-a-post"></a>Remove a linked record from a post
