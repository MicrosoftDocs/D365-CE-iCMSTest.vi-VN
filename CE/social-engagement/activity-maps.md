...
ms.locfileid: "375357"
---
# <a name="define-activity-maps-to-view-real-time-data"></a>Define activity maps to view real-time data
...
## <a name="role-privileges"></a>Role privileges  
...
## <a name="create-an-activity-map"></a>Create an activity map  
...
## <a name="view-an-activity-map"></a>View an activity map  
...
## <a name="view-and-understand-sentiment-values-on-an-activity-map"></a>View and understand sentiment values on an activity map  
...
## <a name="view-and-edit-posts-on-an-activity-map"></a>View and edit posts on an activity map  
...
## <a name="understand-the-posts-peaks-on-an-activity-map"></a>Understand the posts peaks on an activity map  
...
## <a name="view-conversation-insights-on-an-activity-map"></a>View conversation insights on an activity map  
...
## <a name="filter-a-specific-area-of-an-activity-map"></a>Filter a specific area of an activity map  
...
## <a name="view-an-activity-maps-data-in-other-areas-of-includepn-social-engagement-shortincludespn-social-engagement-shortmd"></a>View an activity map’s data in other areas of [!INCLUDE[pn-social-engagement-short](../includes/pn-social-engagement-short.md)]
...
## <a name="delete-an-activity-map"></a>Delete an activity map  
...
## <a name="view-an-activity-map-on-a-large-screen"></a>View an activity map on a large screen  
