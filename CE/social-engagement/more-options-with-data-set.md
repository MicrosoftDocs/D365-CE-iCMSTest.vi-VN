...
ms.locfileid: "375680"
---
# <a name="explore-more-options-with-your-data-set"></a>Explore more options with your data set
...
## <a name="to-pass-a-data-set-to-a-different-application-area"></a>To pass a data set to a different application area  
