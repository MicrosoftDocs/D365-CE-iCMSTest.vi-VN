...
ms.locfileid: "375367"
---
# <a name="perform-visual-filtering-on-widgets"></a>Perform visual filtering on widgets
...
## <a name="add-filters-to-perform-focused-analysis-on-analytics-pages"></a>Add filters to perform focused analysis on Analytics pages  
...
## <a name="visual-filtering-for-text-based-widgets"></a>Visual filtering for text-based widgets  
...
## <a name="visual-filtering-for-list-based-widgets"></a>Visual filtering for list-based widgets  
