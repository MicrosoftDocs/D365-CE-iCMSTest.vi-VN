...
ms.locfileid: "375629"
---
# <a name="stay-up-to-date-with-alerts"></a>Stay up to date with alerts
...
## <a name="view-your-alerts-list"></a>View your alerts list
...
## <a name="change-or-delete-an-alert"></a>Change or delete an alert
...
### <a name="change-an-alert"></a>Change an alert
...
## <a name="manage-alert-recipients-as-administrator"></a>Manage alert recipients as administrator
...
## <a name="set-a-trend-alerts-sensitivity"></a>Set a trend alert's sensitivity
