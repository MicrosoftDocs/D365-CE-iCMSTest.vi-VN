...
ms.locfileid: "375599"
---
# <a name="manage-your-post-quota"></a>Manage your post quota
...
## <a name="get-the-post-quota-status"></a>Get the post quota status  
...
## <a name="keep-the-post-quota-healthy"></a>Keep the post quota healthy  
...
### <a name="impact-of-exceeding-limits"></a>Impact of exceeding limits  
...
### <a name="understand-estimations"></a>Understand estimations  
...
## <a name="buy-additional-quota"></a>Buy additional quota
...
### <a name="to-buy-add-on-subscriptions-for-includepnnetbreezeshortincludespn-social-engagement-shortmd"></a>To buy add-on subscriptions for [!INCLUDE[pn_netbreeze_short](../includes/pn-social-engagement-short.md)]
