...
ms.locfileid: "375697"
---
# <a name="address-customer-service-scenarios-on-social-media-with-social-engagement"></a>Address customer service scenarios on social media with Social Engagement
...
## <a name="social-customer-care-scenario-overview"></a>Social customer care scenario overview
...
## <a name="manage-social-profiles-to-participate-in-conversations"></a>Manage social profiles to participate in conversations
...
## <a name="use-intelligence-to-boost-productivity"></a>Use intelligence to boost productivity
...
## <a name="create-support-cases-from-social-posts"></a>Create support cases from social posts
...
## <a name="establish-workflows-and-collaborate-with-other-users"></a>Establish workflows and collaborate with other users
