...
ms.locfileid: "386335"
---
# <a name="hosted-application-toolkit-hat-architecture"></a>Hosted Application Toolkit (HAT) architecture
...
## <a name="hat-components"></a>Thành phần HAT  
...
## <a name="application-startup-process"></a>Application startup process  
...
### <a name="see-also"></a>Xem thêm  
 [Nền tảng Tích hợp Ứng dụng UII](../unified-service-desk/uii-application-integration-framework.md)   
