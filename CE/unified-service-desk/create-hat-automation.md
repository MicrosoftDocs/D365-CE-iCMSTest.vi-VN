...
ms.locfileid: "387078"
---
# <a name="create-hat-automation-in-unified-service-desk"></a>Create HAT automation in Unified Service Desk
...
## <a name="create-hat-automation"></a>Create HAT automation  
...
<a name="action"></a>   
## <a name="configure-an-action-to-run-the-automation"></a>Configure an action to run the automation  
...
<a name="verify"></a>   
## <a name="verify-the-hat-hosted-control-with-automation"></a>Verify the HAT hosted control with automation  
...
<a name="sample"></a>   
## <a name="view-sample-automations"></a>View sample automations  
...
### <a name="see-also"></a>Xem thêm  
 [Sử dụng hoạt động tự động hóa HAT](../unified-service-desk/use-hat-automation-activities.md)   
