...
ms.locfileid: "388752"
---
# <a name="session-timer-custom-hosted-control"></a>Session Timer (Custom Hosted Control)
...
<a name="Actions"></a>   
## <a name="actions-for-the-timer-hosted-control"></a>Actions for the Timer hosted control  
...
## <a name="configure-threshold-limits-and-colors-for-the-timer-hosted-control"></a>Configure threshold limits and colors for the Timer hosted control  
