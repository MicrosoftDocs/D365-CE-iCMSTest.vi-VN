...
ms.locfileid: "387939"
---
# <a name="use-the-generic-listener-adapter-in-unified-service-desk"></a>Use the generic listener adapter in Unified Service Desk
...
<a name="How"></a>   
## <a name="how-does-the-generic-listener-work"></a>How does the generic listener work  
...
|     Tham số     |                                                                                                                                                                                    Mô tả                                                                                                                                                                                    | Values in the example URL |
|-------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|
...
<a name="Configure"></a>   
## <a name="configure-the-cti-desktop-manager-hosted-control-for-generic-listener-adapter"></a>Configure the CTI Desktop Manager hosted control for generic listener adapter  
...
<a name="ChangePort"></a>   
## <a name="change-the-port-of-generic-listener"></a>Change the port of generic listener  
...
5. Type the following values in the fields:  
   ...
   |-----------|-----------|  
   |Tên|GenericListener|  
   |Value|Specify the new URL for the listener. Ví dụ: `http://localhost:5001/`|  
