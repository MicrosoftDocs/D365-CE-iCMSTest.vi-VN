...
ms.locfileid: "382380"
---
# <a name="includepnunifiedservicedeskincludespn-unified-service-deskmd-data-compliance-under-gdpr"></a>[!INCLUDE[pn_unified_service_desk](../../includes/pn-unified-service-desk.md)] data compliance under GDPR
...
## <a name="audit-log-files"></a>Audit log files

### <a name="standard-auditing-by-using-an-audit--diagnostic-record"></a>Standard auditing by using an Audit & Diagnostic record
...
If you configure audit logging using the standard auditing by adding an audit flag, the events and logs are present in the **UII_auditBase** table in the organization database.
...
## <a name="diagnostic-log-files"></a>Diagnostic log files
...
## <a name="telemetry-data"></a>Telemetry data
