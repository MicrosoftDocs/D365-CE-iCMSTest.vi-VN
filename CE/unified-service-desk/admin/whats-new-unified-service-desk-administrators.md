...
ms.locfileid: "382565"
---
# <a name="whats-new-in-unified-service-desk-for-administrators"></a>Tính năng mới trong Unified Service Desk cho quản trị viên

::: moniker range="dynamics-usd-4"

## <a name="whats-new-in-unified-service-desk-41"></a>What's new in Unified Service Desk 4.1
...
### <a name="web-client---unified-interface-migration-assistant"></a>Máy khách web - Trợ lý Di chuyển Giao diện Hợp nhất
...
### <a name="prevent-accidental-closure-of-unified-service-desk-unified-service-desk"></a>Prevent Accidental Closure of Unified Service Desk Unified Service Desk
...
### <a name="unified-interface-km-control"></a>Unified Interface KM Control
...
### <a name="unified-blue-theme-for-unified-service-desk"></a>Unified Blue theme for Unified Service Desk
...
### <a name="unified-service-desk-administrator-app"></a>Unified Service Desk Administrator App
...
### <a name="unified-interface-settings"></a>Thiết đặt Giao diện Hợp nhất
...
### <a name="show-feedback-window-to-agents"></a>Show feedback window to agents
...
## <a name="whats-new-in-includepn-unified-service-desk-3-3includespn-unified-service-desk-3-3md"></a>Nội dung mới trong [!INCLUDE[pn-unified-service-desk-3-3](../../includes/pn-unified-service-desk-3-3.md)]
...
|                                                                                                                                          Phiên bản [!INCLUDE[pn_unified_service_desk](../../includes/pn-unified-service-desk.md)]                                                                                                                                          |                                                                                                                                                      Khả năng dùng                                                                                                                                                      |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
### <a name="improve-includepnunifiedservicedeskincludespn-unified-service-deskmd"></a>Improve [!INCLUDE[pn_unified_service_desk](../../includes/pn-unified-service-desk.md)]
...
### <a name="comply-with-the-general-data-protection-regulation-gdpr"></a>Comply with the General Data Protection Regulation (GDPR)
...
## <a name="whats-new-in-includepn-unified-service-desk-3-2includespn-unified-service-desk-3-2md"></a>Nội dung mới trong [!INCLUDE[pn-unified-service-desk-3-2](../../includes/pn-unified-service-desk-3-2.md)]


### <a name="performance-enhancement-for-crm-page-loads"></a>Performance enhancement for CRM page loads
...
### <a name="includepnunifiedservicedeskincludespn-unified-service-deskmd-helps-to-recover-an-internet-explorer-process-instance"></a>[!INCLUDE[pn_unified_service_desk](../../includes/pn-unified-service-desk.md)] helps to recover an Internet Explorer process instance
...
### <a name="performance-data-collection-using-keyboard-shortcuts-and-application-configuration-file"></a>Performance data collection using keyboard shortcuts and application configuration file

#### <a name="collect-performance-data-using-keyboard-shortcut"></a>Collect performance data using keyboard shortcut 
...
#### <a name="collect-startup-performance-data-using-application-configuration-file"></a>Collect startup performance data using application configuration file 
...
### <a name="system-administrator-configurable-uii-options"></a>System administrator configurable UII options
...
## <a name="whats-new-in-includepn-unified-service-desk-3-1includespn-unified-service-desk-3-1md"></a>Nội dung mới trong [!INCLUDE[pn-unified-service-desk-3-1](../../includes/pn-unified-service-desk-3-1.md)]

### <a name="support-for-the-latest"></a>Support for the latest
...
### <a name="security-enhancements-user-session-and-access-management"></a>Nâng cấp bảo mật: Quản lý truy cập và phiên người dùng
...
### <a name="security-enhancements-tls-requirements"></a>Security enhancements: TLS requirements
...
### <a name="unified-service-desk-limitations-with-dynamics-365-for-customer-engagement-apps-version-90"></a>Unified Service Desk limitations with Dynamics 365 for Customer Engagement apps version 9.0

These are the limitations:
- **Unified Interface**: Apps built using Unified Interface are not supported with [!INCLUDE[pn_unified_service_desk](../../includes/pn-unified-service-desk.md)]. Thông tin khác: [Khuôn khổ Giao diện Hợp nhất cho các ứng dụng mới](/dynamics365/get-started/whats-new/customer-engagement/new-in-july-2017-update#unified-interface-framework-for-new-apps)
...
- **Embedded intelligence**: Although you can view information from the relationship assistant in the [!INCLUDE[pn_unified_service_desk](../../includes/pn-unified-service-desk.md)] client, you cannot interact with the information in the client. Thông tin khác: [Thông tin được nhúng](/dynamics365/customer-engagement/sales-enterprise/embedded-intelligence)
- **LinkedIn Sales Navigator for Microsoft Dynamics 365 for Customer Engagement apps for Sales**:  This is not supported.
- **Bộ tùy chọn đa lựa chọn**: Dù bộ tùy chọn đa lựa chọn hiển thị bình thường khi được lưu trữ trong Unified Service Desk (bằng cách dùng loại [Trang CRM](../crm-page-hosted-control.md) của kiểm soát tổ chức), bạn không thể thay đổi các lựa chọn trong bộ tùy chọn đa lựa chọn bằng cách dùng API Unified Service Desk.
- **URL addressability in business apps**:  Business apps (app modules) use the appid value in the URLs to refer to resources displayed in an app. For example: “https://<OrgName>.crm.dynamics.com/main.aspx?appid=b0f40cd2-22a6-e711-a94e-000d3a1a7a9b&pagetype=entitylist&etn=bookableresourcebooking.” Unified Service Desk không hỗ trợ việc sử dụng các giá trị appid trong URL để tham chiếu tới một nguồn lực. Thông tin khác: [Thiết kế ứng dụng tùy chỉnh dành cho doanh nghiệp bằng công cụ thiết kế ứng dụng](/dynamics365/customer-engagement/customize/design-custom-business-apps-using-app-designer)
...
### <a name="error--diagnostics-reporting-settings-moved-to-audit--diagnostics-settings-area"></a>Error  diagnostics reporting settings moved to Audit & Diagnostics Settings area  
 Các phiên bản trước đây duy trì thiết đặt báo cáo chẩn đoán lỗi trong khu vực Tùy chọn của giải pháp [!INCLUDE[pn_unified_service_desk](../../includes/pn-unified-service-desk.md)]. Với bản phát hành này, để đơn giản hóa cấu hình, thiết đặt báo cáo chẩn đoán lỗi đã được chuyển sang khu vực Thiết đặt Kiểm tra & Chẩn đoán. [!INCLUDE[proc_more_information](../../includes/proc-more-information.md)] [Diagnostics](../../unified-service-desk/admin/configure-auditing-diagnostics-unified-service-desk.md#BKMK_Diagnostics)  

### <a name="support-for-jaws-screen-reader"></a>Hỗ trợ cho bộ đọc màn hình JAWS  
 Giờ đây, bạn có thể dùng JAWS (Truy cập Công việc kèm theo Giọng nói) phiên bản 18 cho ứng dụng bộ đọc màn hình Windows cho đầu ra giọng nói với máy khách [!INCLUDE[pn_unified_service_desk](../../includes/pn-unified-service-desk.md)]. [!INCLUDE[proc_more_information](../../includes/proc-more-information.md)] [Accessibility in Unified Service Desk](https://go.microsoft.com/fwlink/?linkid=826563)  

::: moniker-end

## <a name="see-also"></a>Xem thêm  
 [What’s New in Unified Service Desk for developers](../../unified-service-desk/what-s-new-in-unified-service-desk.md) [Overview of Unified Service Desk](../../unified-service-desk/admin/overview-unified-service-desk.md)   
