...
ms.locfileid: "382607"
---
# <a name="how-to-migrate-unified-service-desk-configurations-from-dynamics-365-for-customer-engagement-apps-web-client-to-unified-interface"></a>How to migrate Unified Service Desk configurations from Dynamics 365 for Customer Engagement apps Web Client to Unified Interface
...
## <a name="step-1-use-migration-assistant-to-fetch-and-migrate-the-web-client-configurations"></a>Step 1: Use migration assistant to fetch and migrate the Web Client configurations
...
## <a name="step-2-import-the-usdwebresources-folder"></a>Step 2: Import the USDWebResources folder
...
## <a name="step-3-use-configuration-migration-tool-to-import-and-deploy-the-configurations-on-unified-interface-app"></a>Step 3: Use Configuration Migration Tool to import and deploy the configurations on Unified Interface App
...
## <a name="test-the-deployment-of-the-configurations-on-the-target-unified-interface-app"></a>Test the deployment of the configurations on the target Unified Interface App.
...
For example, the selected configuration elements are as follows:
  ...
  |Configuration Name|Mô tả|
  |-------|-------|
  |KB Article| Trang CRM|
  |KB Search| Kiểm soát KM|
