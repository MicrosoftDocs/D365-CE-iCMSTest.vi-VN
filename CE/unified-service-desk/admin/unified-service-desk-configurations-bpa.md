...
ms.locfileid: "382587"
---
# <a name="includepnunifiedservicedeskincludespn-unified-service-deskmd-configurations"></a>[!INCLUDE[pn_unified_service_desk](../../includes/pn-unified-service-desk.md)] Configurations
...
## <a name="internal-wpf-hosting-type"></a>Internal WPF Hosting Type
...
## <a name="actions-calls-in-pageloadcomplete-event"></a>Actions Calls in PageLoadComplete Event
...
> [!Note]
> The **DataReady** event is available for use in [!INCLUDE[pn_unified_service_desk](../../includes/pn-unified-service-desk.md)] 3.0 or later.

## <a name="actions-calls-with-events"></a>Actions Calls with Events
...
|**Phiên mới**|A **SessionNew** event occurs when a new session is created.|
|**Phiên đã kích hoạt**|A **SessionActivated** event occurs when a new session is activated.|
|**Phiên đã hủy kích hoạt**|A **SessionDeactivated** event occurs when a new session is deactivated.|
|**Đã đóng phiên**|A **SessionClosed** event occurs when a session is closed.|
...
## <a name="number-of-navigation-rules"></a>Number of Navigation Rules
...
## <a name="show-script-errors-showscripterrors"></a>Show Script Errors (ShowScriptErrors)
...
## <a name="client-caching"></a>Client Caching
...
## <a name="maximum-number-of-sessions-maxnumberofsessions"></a>Maximum Number of Sessions (maxNumberOfSessions)
...
|Mức độ nghiêm trọng| maxNumberOfSessions |
|---------|---------------------|
| Lỗi   | 0                   |
| Lỗi   | More than 5         |
| Cảnh báo | 4 or 5              |
...
## <a name="help-improve-includepnunifiedservicedeskincludespn-unified-service-deskmd-helpimproveusd"></a>Help Improve [!INCLUDE[pn_unified_service_desk](../../includes/pn-unified-service-desk.md)] (HelpImproveUSD)
...
## <a name="internet-explorer-pooling-internetexplorerpooling"></a>Internet Explorer Pooling (InternetExplorerPooling)
...
Internet Explorer Pooling enhances performance of CRM entity page loading in [!INCLUDE[pn_unified_service_desk](../../includes/pn-unified-service-desk.md)].<br> [!INCLUDE[pn_unified_service_desk](../../includes/pn-unified-service-desk.md)] works best when the **InternetExplorerPooling** option is set to **true**. You must configure the **InternetExplorerPooling** option to set it to **true**.
...
## <a name="activity-tracking-enabled"></a>Activity Tracking Enabled
...
## <a name="diagnostic-tracking-enabled"></a>Diagnostic Tracking Enabled
...
## <a name="enable-exit-monitoring"></a>Enable Exit Monitoring
...
## <a name="enable-crash-dump-generation"></a>Enable Crash Dump Generation
...
## <a name="internet-explorer-webpage-recovery-iewebpagerecovery"></a>Internet Explorer Webpage Recovery (IEWebPageRecovery)
...
## <a name="process-termination-threshold-processterminationthreshold"></a>Process Termination Threshold (ProcessTerminationThreshold)
...
**ProcessTerminationThreshold** indicates the timeout period for the duration (in milliseconds) that the [!INCLUDE[pn_unified_service_desk](../../includes/pn-unified-service-desk.md)] monitoring process (usdmp.exe) waits before terminating an unresponsive Internet Explorer process, which also causes [!INCLUDE[pn_unified_service_desk](../../includes/pn-unified-service-desk.md)] to become unresponsive. [!INCLUDE[pn_unified_service_desk](../../includes/pn-unified-service-desk.md)] works best when **ProcessTerminationThreshold** option is set between the range **0** and **30000**.
