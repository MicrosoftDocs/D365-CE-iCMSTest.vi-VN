...
ms.locfileid: "382384"
---
# <a name="includepn-internet-explorerincludespn-internet-explorermd-settings"></a>[!include[pn-internet-explorer](../../includes/pn-internet-explorer.md)] settings
...
## <a name="tab-process-growth-tabprocgrowth"></a>Tab Process Growth (TabProcGrowth)
...
## <a name="tab-shutdown-delay-tabshutdowndelay"></a>Tab Shutdown Delay (TabShutdownDelay)
...
1. Open **C:/** > **[!include[pn-ms-windows-short](../../includes/pn-ms-windows-short.md)]** > **regedit**.
2. Truy cập `Computer\HKEY\CURRENT\USER\Software\Microsoft\Internet Explorer\Main`.
...
## <a name="enable-enhanced-protected-mode"></a>Enable Enhanced Protected Mode
...
## <a name="enable-automatic-crash-recovery"></a>Enable Automatic Crash Recovery
...
1. Open **C:/** > **[!include[pn-ms-windows-short](../../includes/pn-ms-windows-short.md)]** > **regedit**.
2. Truy cập `Computer\HKEY\CURRENT\USER\Software\Microsoft\Internet Explorer\Recovery`.
...
## <a name="enable-protected-mode"></a>Enable Protected Mode
...
1. Open **C:/** > **[!include[pn-ms-windows-short](../../includes/pn-ms-windows-short.md)]** > **regedit**.
2. Truy cập `Computer\HKEY\CURRENT\USER\Software\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\\\<numerically named key folder>`. <br>
...
## <a name="cleanup-htcs"></a>Cleanup HTCs
...
3. Truy cập `Computer\HKEY\CURRENT\USER\Software\Microsoft\Internet Explorer`.
4. Right-click **Cleanup HTCs**, and then select **Modify**.
5. In the **Value data** field, select **Yes**.
6. Chọn **OK**.

## <a name="includepn-internet-explorerincludespn-internet-explorermd-version"></a>Phiên bản [!include[pn-internet-explorer](../../includes/pn-internet-explorer.md)]
