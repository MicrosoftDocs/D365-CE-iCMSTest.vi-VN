...
ms.locfileid: "382413"
---
# <a name="generate-performance-data-logs-performance-data-collection"></a>Generate performance data logs (Performance data collection)
...
## <a name="use-application-configuration-file-unifiedservicedeskexeconfig-to-generate-performance-data-log"></a>Use application configuration file (UnifiedServiceDesk.exe.config) to generate performance data log
...
## <a name="use-keyboard-shortcut-to-generate-performance-data-log"></a>Use keyboard shortcut to generate performance data log
...
### <a name="start-performance-data-collection-using-a-keyboard-shortcut"></a>Start performance data collection using a keyboard shortcut
...
### <a name="stop-performance-data-collection-using-keyboard-shortcut"></a>Stop performance data collection using keyboard shortcut
...
## <a name="location-of-the-performance-data-file"></a>Location of the performance data file
...
|Thuộc tính|Giá trị Mặc định|New Value|
|:------|:------|:------|
|**Location**|**LocalUserApplicationDirectory**|**Tùy chỉnh**|
...
## <a name="configure-a-performance-data-collection-keyboard-shortcut"></a>Configure a performance data collection keyboard shortcut
