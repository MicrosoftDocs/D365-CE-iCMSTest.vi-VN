...
ms.locfileid: "386384"
---
# <a name="unified-service-desk-known-issues-and-limitations"></a>Unified Service Desk known issues and limitations

::: moniker range="dynamics-usd-4"

## <a name="public-preview-unified-service-desk-41-known-issues-and-limitations"></a>Public Preview: Unified Service Desk 4.1 known issues and limitations

### <a name="preview-edge-process"></a>Preview: Edge process

#### <a name="support-for-closeandprompt-action-in-edge-process"></a>Support for CloseAndPrompt action in Edge process
...
#### <a name="support-for-alert-dialog-with-webview-control"></a>Support for alert dialog with WebView control
...
#### <a name="support-for-confirm-dialog"></a>Support for confirm dialog
...
#### <a name="support-for-multiple-page-navigation-in-edge-process"></a>Support for multiple page navigation in Edge process
...
#### <a name="use-windowtopnotifyusd-to-open-event-in-a-new-browser"></a>Use window.top.notifyUSD to open event in a new browser
...
#### <a name="using-a-long-running-script-with-edge-process-freezes-unified-service-desk"></a>Using a long-running script with Edge process freezes Unified Service Desk
...
#### <a name="support-for-downloading-files-with-edge-process"></a>Support for downloading files with Edge process
...
#### <a name="support-for-launching-application-for-a-uri-with-edge-webview-control"></a>Support for launching application for a URI with Edge WebView control
...
#### <a name="kb-article-support-with-edge-process"></a>KB article support with Edge process
...
To open an KB article, only the article url is sufficient. Ví dụ: `url=[[KB Search.articleurl]g]`

Now, save the configuration. Login to Unified Service Desk and open any article to see the article contents.

## <a name="unified-service-desk-40-known-issues-and-limitations"></a>Unified Service Desk 4.0 known issues and limitations

### <a name="select-articles-from-the-unified-interface-kb-control-in-the-unified-service-desk-displays-error"></a>Select articles from the Unified Interface KB Control in the Unified Service Desk displays error
...
### <a name="toolbar-shows-unified-blue-theme-instead-air-theme"></a>Toolbar shows Unified Blue theme instead Air theme
...
### <a name="unified-interface-form-does-not-close-the-tab-and-navigates-to-dashboard"></a>Unified Interface form does not close the tab and navigates to Dashboard
...
### <a name="sub-actions-calls-is-not-available-in-unified-service-desk-administrator-app"></a>Sub Actions Calls is not available in Unified Service Desk Administrator app
...
### <a name="support-for-relevance-search-search-technique-in-unified-interface-km-control"></a>Support for Relevance Search (search technique) in Unified Interface KM Control
...
### <a name="quick-create-in-unified-service-administrator-app"></a>Quick create in Unified Service Administrator app
...
### <a name="navigation-and-command-bar-configuration-does-not-execute-when-internet-explorer-pooling-is-enabled"></a>Navigation and command bar configuration does not execute when Internet Explorer pooling is enabled
...
## <a name="unified-service-desk-33-known-issues-and-limitations"></a>Unified Service Desk 3.3 known issues and limitations
...
### <a name="best-practices-analyzer"></a>Best Practices Analyzer
...
### <a name="clicking-back-button-in-a-session-does-not-perform-navigation-to-original-url"></a>Clicking back button in a session does not perform navigation to original URL
...
#### <a name="step-1-configure-showoutside-action-call"></a>Step 1: Configure ShowOutside action call
...
#### <a name="step-2-configure-window-navigation-rules-and-add-the-action-call"></a>Step 2: Configure Window Navigation Rules and add the Action Call
...
5. On the **New Window Navigation Rules** page, specify the following values.
   ...
   | Trường | Value |
   |-------------|----------------|
   |Tên| Show Outside Rule|
   |Thứ tự | 1 <br> **Note:** You can specify any order that is lesser than the default list of Window Navigation Rules. |
   | Url | https://www.bing.com <br> **Note:** You must to specify a URL to which you want to navigate.|
   |Loại định tuyến | Cửa sổ bật lên |
   | Điểm đến | Thẻ |
   |Hành động | Không có |
