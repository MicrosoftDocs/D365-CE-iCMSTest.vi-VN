...
ms.locfileid: "387268"
---
# <a name="release-history-for-unified-service-desk"></a>Release history for Unified Service Desk
...
## <a name="release-history-for-public-preview-of-include-pn-unified-service-desk-4-1includespn-unified-service-desk-4-1md-december-2018"></a>Release history for public preview of [!INCLUDE [pn-unified-service-desk-4-1](../includes/pn-unified-service-desk-4-1.md)], December 2018
...
## <a name="release-history-for-include-pn-unified-service-desk-4-0includespn-unified-service-desk-4-0md-august-2018"></a>Release history for [!INCLUDE [pn-unified-service-desk-4-0](../includes/pn-unified-service-desk-4-0.md)], August 2018
...
| [Preview feature - Unified Service Desk Administrator app](admin/unified-service-desk-administrator-app.md) |  Ứng dụng Quản trị viên Unified Service Desk mang tới trải nghiệm phong phú cho công tác quản trị và quản lý ứng dụng máy khách Unified Service Desk.<br>The Administrator app, which is built based on the Unified Interface framework, has the same configurational capabilities as the Unified Service Desk administrator in Dynamics 365 for Customer Engagement apps Web Client. <br><br> New topic under [Administer and manage Unified Service Desk](admin/administer-manage-unified-service-desk.md). |
...
| [Quản lý tùy chọn cho Unified Service Desk](admin/manage-options-unified-service-desk.md) | Updated information about new UII options such as **HideConfirmationDialog** and  **ShowNPSDialog**. |
...
| [Tùy chỉnh các chủ đề trong Unified Service Desk](customize-themes-in-unified-service-desk.md) | Updated information about the new Unified Blue theme for Unified Interface App in Unified Service Desk. |
...
| [Tab Phiên (Kiểm soát tổ chức)](session-tabs-hosted-control.md) | Updated new action, **SwitchSession** action that is used to switch between local sessions  and switch between local and global sessions. <br><br> **Note:** This is a preview feature.|
...
## <a name="release-history-for-include-pn-unified-service-desk-3-3includespn-unified-service-desk-3-3md-april-2018"></a>Release history for [!INCLUDE [pn-unified-service-desk-3-3](../includes/pn-unified-service-desk-3-3.md)], April 2018
...
|                                          [Đặt cấu hình thanh công cụ trong ứng dụng của bạn](../unified-service-desk/configure-toolbars-application.md)                                           |                                                                                                                                                                                                            Updated information  about **Custom styles** in toolbar.                                                                                                                                                                                                             |
...
## <a name="release-history-for-include-pn-unified-service-desk-3-2includespn-unified-service-desk-3-2md-february-2018"></a>Release history for [!INCLUDE [pn-unified-service-desk-3-2](../includes/pn-unified-service-desk-3-2.md)], February 2018
...
|               [Quản lý tùy chọn cho Unified Service Desk](../unified-service-desk/admin/manage-options-unified-service-desk.md)               |                                       Information about new UII options                                       |
...
## <a name="release-history-for-include-pn-unified-service-desk-3-1includespn-unified-service-desk-3-1md-november-2017"></a>Release history for [!INCLUDE [pn-unified-service-desk-3-1](../includes/pn-unified-service-desk-3-1.md)], November 2017
For information about this release, see [New feature information for administrators](admin/whats-new-unified-service-desk-administrators.md).

<a name="Release_3_0"></a>   
## <a name="release-history-for-include-pn-unified-service-desk-3-0includespn-unified-service-desk-3-0md-august-2017"></a>Release history for [!INCLUDE [pn-unified-service-desk-3-0](../includes/pn-unified-service-desk-3-0.md)], August 2017  
