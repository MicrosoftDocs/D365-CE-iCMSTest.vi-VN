...
ms.locfileid: "388621"
---
# <a name="integrate-with-citrix-applications-in-unified-service-desk"></a>Integrate with Citrix applications in Unified Service Desk
...
<a name="ServerSide"></a>   
## <a name="configure-server-side-component-for-citrix-integration"></a>Configure server-side component for Citrix integration  
...
<a name="ClientSide"></a>   
## <a name="configure-client-side-component-for-citrix-integration"></a>Configure client-side component for Citrix integration  
...
### <a name="configure-a-remote-hosted-application"></a>Configure a Remote Hosted Application  
...
9. Lưu kiểm soát tổ chức.  
  
### <a name="copy-executable-apply-registry-patch-and-add-citrix-config-settings"></a>Copy executable, apply registry patch, and add Citrix config settings  
...
## <a name="citrix-integration-how-does-it-work"></a>Citrix integration: How does it work?  
...
## <a name="sample-citrix-adapters"></a>Sample Citrix adapters  
 Here are some sample Citrix adapters available for you to review/try.  
  
### <a name="sample-application-adapter"></a>Sample Application Adapter  
...
### <a name="sample-data-driven-adapter"></a>Sample Data-Driven Adapter  
...
|**Loại**|Microsoft.Uii.HostedApplicationToolkit.DataDrivenAdapter.DdaAutomationAdapter|  
  
<a name="BestPractices"></a>   
## <a name="citrix-integration-best-practices"></a>Citrix integration: Best practices  
