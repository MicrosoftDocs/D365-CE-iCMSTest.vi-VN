...
ms.locfileid: "386258"
---
# <a name="ie-process"></a>IE Process
...
## <a name="memory-and-performance-enhacements"></a>Memory and performance enhacements

The `IE Process` browser control offers significant memory and performance enhancements:  
  
### <a name="better-memory-management"></a>Better memory management
...
### <a name="improved-stability-and-performance"></a>Improved stability and performance
