...
ms.locfileid: "385882"
---
# <a name="use-safedispatcher-for-custom-hosted-controls-in-unified-service-desk"></a>Use SafeDispatcher for custom hosted controls in Unified Service Desk
...
<a name="What"></a>   
## <a name="what-is-safedispatcher"></a>What is SafeDispatcher?  
...
<a name="How"></a>   
## <a name="how-to-use-safedispatcher"></a>How to use SafeDispatcher?  
...
## <a name="customize-the-safedispatcher-exception-handler"></a>Customize the SafeDispatcher exception handler  
...
<a name="Migrating"></a>   
## <a name="migrating-from-wpf-dispatcher-to-safedispatcher-in-existing-custom-hosted-controls"></a>Migrating from WPF Dispatcher to SafeDispatcher in existing custom hosted controls  
...
## <a name="things-to-consider-when-using-safedispatcher"></a>Things to consider when using SafeDispatcher  
