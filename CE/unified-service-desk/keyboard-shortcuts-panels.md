...
ms.locfileid: "385876"
---
# <a name="keyboard-shortcuts-for-panels-in-unified-service-desk"></a>Keyboard shortcuts for panels in Unified Service Desk
...
## <a name="keyboard-shortcut-to-traverse-through-panels"></a>Keyboard shortcut to traverse through panels  
...
## <a name="assign-keyboard-shortcut-to-panel"></a>Assign keyboard shortcut to panel  
...
## <a name="things-to-consider-while-using-keyboard-shortcut-for-panel"></a>Things to consider while using keyboard shortcut for panel  
...
### <a name="see-also"></a>Xem thêm  
 ...
 [Tạo bố chục bảng điều khiển tùy chỉnh](../unified-service-desk/create-custom-panel-layout.md)
