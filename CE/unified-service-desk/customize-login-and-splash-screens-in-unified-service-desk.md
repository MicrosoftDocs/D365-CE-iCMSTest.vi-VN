...
ms.locfileid: "387163"
---
# <a name="customize-login-and-splash-screens-in-unified-service-desk"></a>Customize login and splash screens in Unified Service Desk
You can customize the branding of [!INCLUDE[pn_unified_service_desk](../includes/pn-unified-service-desk.md)] login and splash screens to change the name and appearance of the application name on the login screen and change the application name, appearance, foreground and background colors of the splash screen by modifying XAML styles.  
  
<a name="What"></a>   
## <a name="what-you-can-customize"></a>What you can customize?  
...
<a name="How"></a>   
## <a name="how-you-can-customize"></a>How you can customize?  
...
<a name="Examples"></a>   
## <a name="customization-examples"></a>Customization examples  
 Here are some customization examples.  
  
### <a name="change-the-application-name-of-login-screen"></a>Change the application name of login screen  
...
### <a name="change-the-application-name-and-appearance-of-splash-screen"></a>Change the application name and appearance of splash screen  
 Update the contents of the `CustomerSplashStyles.xaml` file to the following:  
