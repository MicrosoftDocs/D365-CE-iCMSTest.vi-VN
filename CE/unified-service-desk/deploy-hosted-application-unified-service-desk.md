...
ms.locfileid: "387704"
---
# <a name="deploy-the-hosted-application-to-unified-service-desk"></a>Deploy the hosted application to Unified Service Desk
...
<a name="deploy"></a>   
## <a name="deploy-your-hosted-application-to-unified-service-desk"></a>Deploy your hosted application to Unified Service Desk  
...
<a name="verify"></a>   
## <a name="verify-that-the-application-is-successfully-deployed"></a>Verify that the application is successfully deployed  
