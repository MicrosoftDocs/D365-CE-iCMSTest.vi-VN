...
ms.locfileid: "386333"
---
# <a name="how-to-configure-notifications-in-unified-service-desk"></a>How to configure notifications in Unified Service Desk
...
You can use the Alt+1 keys (default) to set your focus on a notification. Nếu có nhiều thông báo hiển thị, bạn có thể ấn Alt+1 lặp lại để di chuyển tuần hoàn qua tất cả các thông báo hiện hoạt trên màn hình. To change the default keyboard shortcut keys for notifications, use the new **PopupNavigationShortcut** UII option to specify the shortcut keys of your choice. More information: [Manage Options for Unified Service Desk](admin/manage-options-unified-service-desk.md)  
  
<a name="Define"></a>   
## <a name="define-layout-and-behavior-of-notification-using-forms"></a>Define layout and behavior of notification using forms  
...
### <a name="command-binding-to-execute-uii-actions-action-calls-and-events-from-notification"></a>Command binding to execute UII actions, action calls, and events from notification  
...
<a name="Countdown"></a>   
### <a name="display-countdown-timer-in-notifications"></a>Display countdown timer in notifications  
 ...
 For example, you can add a label element in form  XAML that is bound to the `TimeoutProperty` parameter to display countdown in seconds after which the notification message will be closed. Ví dụ:  
...
### <a name="sample-xaml-for-notification"></a>Sample XAML for notification  
...
<a name="Show"></a>   
## <a name="show-notifications-using-popup-notification-control"></a>Show notifications using Popup Notification control  
...
<a name="Consume"></a>
## <a name="consume-event-parameters-in-the-form-used-for-notifications"></a>Consume event parameters in the form used for notifications
...
<a name="Multiple"></a>   
## <a name="multiple-notification-controls"></a>Multiple notification controls
...
::: moniker range=">=dynamics-usd-4"
 ### <a name="stack-notifications"></a>Stack notifications
 ...
 Also, you can define the height of the stack by defining the **stackHeight** parameter. The value range is 1 - 100. Giá trị mặc định là 50. If you do not specify any value, the default value (50) is passed. Also, if you specify 0 or specify more than 100, default value (50) is passed. For example, **stackHeight = 60**.
...
::: moniker range="dynamics-usd-3"  
<a name="HowTo"></a>   
## <a name="how-to-configure-a-notification"></a>How to configure a notification?  
...
3. Create an action call to display the notification.</br> For example, create an action call and specify the following: 
    ...
    |Trường|Value|
    |--------|--------|
    |Tên|Action Call for Max Sessions Notifications|
    |Kiểm soát được lưu trữ|MaxSessionNotificationControl|
    |Hành động|Show|
    |Dữ liệu|formName = Sample Notification Form</br>top = 10</br>left = 80</br>timeout = 20</br>stack = true</br>stackHeight = 60
...
### <a name="see-also"></a>Xem thêm  
 ...
 [Thêm cuộc gọi hành động vào một sự kiện](../unified-service-desk/add-action-calls-event.md)   
