...
ms.locfileid: "388414"
---
# <a name="configure-the-hosted-application"></a>Configure the hosted application
...
3. In the **Application Properties** dialog box, specify the required information. The following table describes the various application properties.  
   ...
   |      Nhóm hiển thị       |                                                                                                                                                                      Specifies where the application will be hosted in [!INCLUDE[pn_unified_service_desk](../includes/pn-unified-service-desk.md)], for example, MainPanel or WorkflowPanel.                                                                                                                                                                      |
