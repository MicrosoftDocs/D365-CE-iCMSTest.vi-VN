...
ms.locfileid: "387970"
---
# <a name="types-of-hat-automation-activities-in-unified-service-desk"></a>Types of HAT automation activities in Unified Service Desk
...
<a name="AIF"></a>   
## <a name="application-integration-framework-aif-action-activities"></a>Application Integration Framework (AIF) action activities  
...
- `ActionData`: Data required for performing the action. Tùy chọn.  
...
- `ControlName`: Name of the control that initiates the event. Tùy chọn.  
...
<a name="AIFContext"></a>   
## <a name="aif-context-activities"></a>AIF context activities  
...
<a name="DDA"></a>   
## <a name="dda-activities"></a>DDA activities  
